...
#   filename:  orbiterx_app_server_protocol.v2.schemas.json
...
class OrbiterXAppServerProtocolV2(BaseModel):
    pass
...
class AmazonBedrockCredentialSource(Enum):
    orbiterx_managed = "orbiterxManaged"
...
class OrbiterXErrorInfoValue(Enum):
...
class HttpConnectionFailedOrbiterXErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamConnectionFailedOrbiterXErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamDisconnectedOrbiterXErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseTooManyFailedAttemptsOrbiterXErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ProjectConfigLayerSource(BaseModel):
    ...
    dot_orbiterx_folder: Annotated[AbsolutePathBuf, Field(alias="dotOrbiterXFolder")]
...
class ChatgptAuthTokensLoginAccountParams(BaseModel):
    ...
    chatgpt_plan_type: Annotated[
        ...
        Field(
            ...
            description="Optional plan type supplied by the client.\n\nWhen `null`, OrbiterX attempts to derive the plan type from access-token claims. If unavailable, the plan defaults to `unknown`.",
        ),
    ] = None
    type: Annotated[
...
class RateLimitResetType(Enum):
    orbiterx_rate_limits = "orbiterxRateLimits"
    unknown = "unknown"
...
class ThreadApproveGuardianDeniedActionParams(BaseModel):
    ...
    event: Annotated[
        Any, Field(description="Serialized `orbiterx_protocol::protocol::GuardianAssessmentEvent`.")
    ]
    thread_id: Annotated[str, Field(alias="threadId")]
...
class ActiveTurnNotSteerableOrbiterXErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class OrbiterXErrorInfo(
    RootModel[
        OrbiterXErrorInfoValue
        | HttpConnectionFailedOrbiterXErrorInfo
        | ResponseStreamConnectionFailedOrbiterXErrorInfo
        | ResponseStreamDisconnectedOrbiterXErrorInfo
        | ResponseTooManyFailedAttemptsOrbiterXErrorInfo
        | ActiveTurnNotSteerableOrbiterXErrorInfo
    ]
):
    model_config = ConfigDict(
        populate_by_name=True,
...
class ChatgptLoginAccountParams(BaseModel):
    ...
    orbiterx_streamlined_login: Annotated[bool | None, Field(alias="orbiterxStreamlinedLogin")] = None
...
class TurnError(BaseModel):
    ...
    orbiterx_error_info: Annotated[OrbiterXErrorInfo | None, Field(alias="orbiterxErrorInfo")] = None
    message: str
...
class GetAccountRateLimitsResponse(BaseModel):
    ...
    rate_limits_by_limit_id: Annotated[
        ...
        Field(
            ...
            description="Multi-bucket view keyed by metered `limit_id` (for example, `orbiterx`).",
        ),
    ] = None
...
class Turn(BaseModel):
    ...
    id: Annotated[
        str, Field(description="Identifier for this turn. OrbiterX-generated turn IDs are UUIDv7.")
    ]
    items: Annotated[
...
class Thread(BaseModel):
    ...
    id: Annotated[
        str, Field(description="Identifier for this thread. OrbiterX-generated thread IDs are UUIDv7.")
    ]
    ...
    source: Annotated[
        SessionSource,
        Field(
            description="Origin of the thread (CLI, VSCode, orbiterx exec, orbiterx app-server, etc.)."
        ),
    ]
