...
PACKAGE_VARIANTS: dict[str, PackageVariant] = {
    "orbiterx": PackageVariant(
        name="orbiterx",
        cargo_bin="orbiterx",
        executable_stem="orbiterx",
    ),
    "orbiterx-app-server": PackageVariant(
        name="orbiterx-app-server",
        cargo_bin="orbiterx-app-server",
        executable_stem="orbiterx-app-server",
    ),
}
