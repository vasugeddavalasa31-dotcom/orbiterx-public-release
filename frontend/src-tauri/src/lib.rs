    ...
    pub fn run() {
        ...
        builder
            ...
            .setup(|app| {
                ...
                // Start the bundled conversation engine so the UI's persistent
                // WebSocket (ws://127.0.0.1:3001) has a server to talk to in
                // the packaged app — same process start.sh launches in dev.
                crate::app_server::spawn_app_server(app.handle());
            ...
            .run(|app, event| match event {
                tauri::RunEvent::ExitRequested { .. } => {
                    ...
                    crate::app_server::stop_app_server(app);
