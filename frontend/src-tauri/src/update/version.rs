...
pub const UPDATE_MANIFEST_URL: &str =
    "https://github.com/vasugeddavalasa31-dotcom/orbiterx-public-release/releases/latest/download/latest.json";
...
pub const RELEASE_DOWNLOAD_BASE: &str =
    "https://github.com/vasugeddavalasa31-dotcom/orbiterx-public-release/releases/latest/download";
