...
pub fn get_agent_meta(agent_type: AgentType) -> AcpAgentMeta {
    ...
    match agent_type {
        ...
        AgentType::Codex => AcpAgentMeta {
            agent_type,
            supports_mcp: true,
            name: "OrbiterX Engine",
            description: "OrbiterX Autonomous Coding Engine",
