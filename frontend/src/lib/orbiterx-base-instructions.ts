 ...
 * the model batches reads/searches into one chained bash call and the UI
...
- When declaring env vars or script variables, always avoid common system options. Never repurpose \`$HOME\`, \`$home\`, or \`$ORBITERX_HOME\`. Instead, use a task-specific variable name.
