...
export const monacoThemeColors = {
  light: {
    ...
    "diffEditor.insertedTextBackground": "#d9f2e1",
    "diffEditor.removedTextBackground": "#fde3e5",
    "diffEditor.insertedLineBackground": "#e9f8ee",
    "diffEditor.removedLineBackground": "#fdf0f1",
    "diffEditorGutter.insertedLineBackground": "#cfeede",
    "diffEditorGutter.removedLineBackground": "#f9d6d9",
  ...
  dark: {
    ...
    "diffEditor.insertedTextBackground": "#21422b",
    "diffEditor.removedTextBackground": "#4a2529",
    "diffEditor.insertedLineBackground": "#182b1d",
    "diffEditor.removedLineBackground": "#331b1d",
    "diffEditorGutter.insertedLineBackground": "#23512f",
    "diffEditorGutter.removedLineBackground": "#662d32",
