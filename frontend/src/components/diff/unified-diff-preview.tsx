...
const ROW_CLASS: Record<RowMarker, string> = {
  none: "",
  added:
    "border-l-2 border-green-500/60 bg-green-500/10 text-green-900 dark:border-green-400/70 dark:bg-green-500/20 dark:text-green-300",
  deleted:
    "border-l-2 border-red-500/60 bg-red-500/10 text-red-900 dark:border-red-400/70 dark:bg-red-500/20 dark:text-red-300",
  modified:
    "border-l-2 border-blue-500/60 bg-blue-500/10 text-blue-900 dark:border-blue-400/70 dark:bg-blue-500/20 dark:text-blue-300",
}
