    ...
    className={cn(
      ...
      from === "user"
        ? // Outer user capsule hugs its content (`w-fit`) instead of always
          ...
          "is-user ml-auto justify-end w-fit max-w-[min(82%,64ch)]"
        : "is-assistant w-full",
      className
    )}
    {...props}
...
export const MessageContent = ({
  ...
  <div
    className={cn(
      ...
      // ancestor).
      "group-[.is-user]:ml-auto group-[.is-user]:w-fit group-[.is-user]:max-w-full group-[.is-user]:rounded-lg group-[.is-user]:bg-secondary group-[.is-user]:px-3 group-[.is-user]:py-2 group-[.is-user]:text-foreground ws-msg-secondary",
