                ...
                <div className="grid gap-2 @md:grid-cols-2">
                  {addedFiles.map((file) => {
                    ...
                    return (
                      <div
                        key={file.id}
                        className="overflow-hidden rounded-md border border-green-600/30 bg-green-500/5 transition-colors hover:border-green-600/50 hover:bg-green-500/10 dark:border-green-400/30 dark:hover:border-green-400/50"
                      >
                        ...
                        {file.diff && (
                          <div className="border-t border-green-600/20 dark:border-green-400/20">
                            <UnifiedDiffPreview
                              diffText={file.diff}
                              embedded
                              className="h-72"
