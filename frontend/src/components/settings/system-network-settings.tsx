          ...
          <div className="rounded-md border bg-muted/20 px-3 py-3 text-xs space-y-2">
            <div className="flex items-center justify-between gap-3">
              ...
              {checkingUpdate ? (
                ...
                // protocol. Without either there is no release URL to open (the
                // old codeg repo link was removed), so fall back to the check
                // button rather than a dead external link.
                usesTauriUpdater() ||
