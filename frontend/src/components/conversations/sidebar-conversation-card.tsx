          ...
          >
            ...
            >
              ...
              >
                ...
                {/* This row's OWN rail, through the status dot, at the (depth-
                    shifted) rail axis. */}
                <span
                  aria-hidden
                  className={cn(
