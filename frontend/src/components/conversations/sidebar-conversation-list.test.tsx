...
// ── Probes ────────────────────────────────────────────────────────────────
// ConversationStatusDot renders once per card body → counts card re-renders.
// The Folder / FolderOpen lucide icon renders once per FolderHeader body →
// counts folder re-renders. Both increment only when the owning memoized
// component does NOT bail out, so they measure exactly the production memo
// path.
...
// Card counts below therefore expect 2 × (re-rendered card count).
