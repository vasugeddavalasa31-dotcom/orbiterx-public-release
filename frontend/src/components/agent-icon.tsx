...
// OrbiterX brand mark: the app's own icon (rounded-square badge with code
// angle brackets and three bubbles — see `AppIcon` / `frontend/public/icon.svg`).
// The `codex` agent in this fork IS the OrbiterX engine, so its sessions carry
// the OrbiterX mark instead of the upstream OpenAI Codex logo.
const OrbiterXColorIcon = memo(function OrbiterXColorIcon({
  size = "1em",
}: {
  size?: string | number
}) {
  ...
  return (
    <svg
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <title>OrbiterX</title>
      <rect width="512" height="512" rx="90" ry="90" fill="#1a1a2e" />
      <polyline
        fill="none"
      ...
      <polyline
        ...
        strokeWidth="32"
      />
      <circle cx="206" cy="256" fill={`url(#${id}-b1)`} opacity="0.95" r="30" />
      <circle cx="256" cy="256" fill={`url(#${id}-b2)`} opacity="0.95" r="36" />
      <circle cx="306" cy="256" fill={`url(#${id}-b3)`} opacity="0.95" r="30" />
      <defs>
        <linearGradient id={`${id}-code`} x1="0%" x2="100%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#dcdfe9" />
          <stop offset="100%" stopColor="#cdd1e2" />
        </linearGradient>
        <linearGradient id={`${id}-b1`} x1="0%" x2="100%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#ff4081" />
          <stop offset="100%" stopColor="#e91e63" />
        </linearGradient>
        <linearGradient id={`${id}-b2`} x1="0%" x2="100%" y1="0%" y2="100%">
          <stop offset="0%" stopColor="#ffeb3b" />
          <stop offset="100%" stopColor="#fdd835" />
        </linearGradient>
        <linearGradient id={`${id}-b3`} x1="0%" x2="100%" y1="0%" y2="100%">
...
const COLOR_ICONS: Partial<Record<AgentType, AnyIcon>> = {
  ...
  // The `codex` agent is the OrbiterX engine in this fork — show the
  // OrbiterX brand mark, not the upstream OpenAI Codex logo.
  codex: OrbiterXColorIcon,
