...
use orbiterx_protocol::openai_models::TruncationMode;
...
const DEFAULT_PERSONALITY_HEADER: &str = "You are OrbiterX, a coding agent based on GPT-5. You and the user share the same workspace and collaborate to achieve the user's goals.";
...
pub fn model_info_from_slug(slug: &str) -> ModelInfo {
    ...
    ModelInfo {
        ...
        apply_patch_tool_type: Some(orbiterx_protocol::openai_models::ApplyPatchToolType::Freeform),
...
fn local_personality_messages_for_slug(slug: &str) -> Option<ModelMessages> {
    match slug {
        "gpt-5.2-orbiterx" | "exp-orbiterx-personality" => Some(ModelMessages {
