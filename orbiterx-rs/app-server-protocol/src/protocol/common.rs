...
pub enum AuthMode {
    /// OpenAI API key provided by the caller and stored by OrbiterX.
    ApiKey,
    /// ChatGPT OAuth managed by OrbiterX (tokens persisted and refreshed by OrbiterX).
    Chatgpt,
    ...
    Headers,
    /// Programmatic OrbiterX auth backed by a registered Agent Identity.
    #[serde(rename = "agentIdentity")]
    #[ts(rename = "agentIdentity")]
    #[strum(serialize = "agentIdentity")]
    AgentIdentity,
    /// Programmatic OrbiterX auth backed by a personal access token.
    #[serde(rename = "personalAccessToken")]
    #[ts(rename = "personalAccessToken")]
    #[strum(serialize = "personalAccessToken")]
    PersonalAccessToken,
    /// Amazon Bedrock bearer token managed by OrbiterX.
...
impl AuthMode {
    ...
    /// Returns whether this mode is backed by OrbiterX services rather than a direct model API.
...
client_request_definitions! {
    ...
    /// Spawn a standalone process (argv vector) without a OrbiterX sandbox.
...
/// Superset of [`orbiterx_file_search::FileMatch`]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
...
server_notification_definitions! {
    ...
    /// This event is internal-only. Used by OrbiterX Cloud.
...
mod tests {
    ...
    fn serialize_initialize_capabilities() -> Result<()> {
        let request = ClientRequest::Initialize {
            ...
            params: v1::InitializeParams {
                client_info: v1::ClientInfo {
                    name: "orbiterx_vscode".to_string(),
    ...
    fn serialize_mcp_server_elicitation_request() -> Result<()> {
        ...
        let params = v2::McpServerElicitationRequestParams {
            ...
            server_name: "orbiterx_apps".to_string(),
        ...
        let response = ClientResponse::ThreadStart {
            ...
            response: v2::ThreadStartResponse {
                ...
                instruction_sources: vec![
                    orbiterx_utils_path_uri::LegacyAppPathString::from_abs_path(&absolute_path(
                        "/tmp/AGENTS.md",
                    )),
                ],
    ...
    fn serialize_account_login_chatgpt_streamlined() -> Result<()> {
        let request = ClientRequest::LoginAccount {
            ...
            params: v2::LoginAccountParams::Chatgpt {
                app_brand: None,
                orbiterx_streamlined_login: true,
                use_hosted_login_success_page: false,
            },
        };
        assert_eq!(
    ...
    fn account_serializes_fields_in_camel_case() -> Result<()> {
        ...
        let orbiterx_managed_bedrock = v2::Account::AmazonBedrock {
            uses_orbiterx_managed_credentials: true,
        };
        assert_eq!(
            json!({
                "type": "amazonBedrock",
                "usesOrbiterXManagedCredentials": true,
            }),
            serde_json::to_value(&orbiterx_managed_bedrock)?,
        );
        ...
        assert_eq!(
            json!({
                "type": "amazonBedrock",
                "usesOrbiterXManagedCredentials": false,
            }),
        ...
        assert_eq!(
            json!({
                ...
                "params": {
                    ...
                    "orbiterxResponsesAsItems": null,
                    "orbiterxResponseItemPrefix": null,
                    "orbiterxResponseHandoffMode": "bemTags",
        ...
        assert_eq!(
            json!({
                ...
                "params": {
                    ...
                    "orbiterxResponsesAsItems": null,
                    "orbiterxResponseItemPrefix": null,
                    "orbiterxResponseHandoffMode": null,
                    "model": null,
                    "outputModality": "audio",
        ...
        let notification =
            ServerNotification::ThreadSettingsUpdated(v2::ThreadSettingsUpdatedNotification {
                ...
                thread_settings: v2::ThreadSettings {
                    ...
                    effort: None,
                    summary: None,
                    collaboration_mode: orbiterx_protocol::config_types::CollaborationMode {
