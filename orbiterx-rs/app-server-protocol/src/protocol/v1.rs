...
pub use orbiterx_protocol::protocol::GitSha;
...
pub struct InitializeResponse {
    ...
    /// Absolute path to the server's $ORBITERX_HOME directory.
...
pub struct ApplyPatchApprovalParams {
    pub conversation_id: ThreadId,
    /// Use to correlate this with [orbiterx_protocol::protocol::PatchApplyBeginEvent]
    /// and [orbiterx_protocol::protocol::PatchApplyEndEvent].
    pub call_id: String,
