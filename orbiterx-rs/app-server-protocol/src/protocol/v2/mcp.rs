...
use orbiterx_protocol::items::McpToolCallError as CoreMcpToolCallError;
use orbiterx_protocol::mcp::CallToolResult as CoreMcpCallToolResult;
use orbiterx_protocol::mcp::McpServerInfo;
use orbiterx_protocol::mcp::Resource as McpResource;
pub use orbiterx_protocol::mcp::ResourceContent as McpResourceContent;
use orbiterx_protocol::mcp::ResourceTemplate as McpResourceTemplate;
use orbiterx_protocol::mcp::Tool as McpTool;
...
v2_enum_from_core!(
    pub enum McpAuthStatus from orbiterx_protocol::protocol::McpAuthStatus {
        Unsupported,
        NotLoggedIn,
        BearerToken,
        OAuth
...
v2_enum_from_core!(
    pub enum McpServerStartupFailureReason from orbiterx_protocol::protocol::McpStartupFailureReason {
...
impl McpServerElicitationAction {
    pub fn to_core(self) -> orbiterx_protocol::approvals::ElicitationAction {
        match self {
            Self::Accept => orbiterx_protocol::approvals::ElicitationAction::Accept,
            Self::Decline => orbiterx_protocol::approvals::ElicitationAction::Decline,
            Self::Cancel => orbiterx_protocol::approvals::ElicitationAction::Cancel,
        }
    }
}
...
pub struct McpServerElicitationRequestParams {
    pub thread_id: String,
    /// Active OrbiterX turn when this elicitation was observed, if app-server could correlate one.
    ///
