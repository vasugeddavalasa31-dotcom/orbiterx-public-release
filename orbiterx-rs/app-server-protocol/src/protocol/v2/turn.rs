...
use orbiterx_protocol::plan_tool::PlanItemArg as CorePlanItemArg;
use orbiterx_protocol::plan_tool::StepStatus as CorePlanStepStatus;
use orbiterx_protocol::user_input::ByteRange as CoreByteRange;
use orbiterx_protocol::user_input::TextElement as CoreTextElement;
...
pub struct TurnStartParams {
    ...
    /// Optional metadata to enrich OrbiterX's ResponsesAPI turn metadata.
    ///
    /// Entries are flattened into the JSON string sent as
    /// `client_metadata["x-orbiterx-turn-metadata"]` on ResponsesAPI HTTP and websocket requests.
    ///
