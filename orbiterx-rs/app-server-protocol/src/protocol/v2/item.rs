...
use orbiterx_experimental_api_macros::ExperimentalApi;
use orbiterx_extension_items::ExtensionItem;
pub use orbiterx_extension_items::image_generation::ImageGenerationItem;
pub use orbiterx_extension_items::sleep::SleepItem;
pub use orbiterx_extension_items::web_search::WebSearchAction;
pub use orbiterx_extension_items::web_search::WebSearchItem;
use orbiterx_protocol::approvals::GuardianAssessmentAction as CoreGuardianAssessmentAction;
use orbiterx_protocol::approvals::GuardianAssessmentDecisionSource as CoreGuardianAssessmentDecisionSource;
use orbiterx_protocol::approvals::GuardianCommandSource as CoreGuardianCommandSource;
use orbiterx_protocol::items::AgentMessageContent as CoreAgentMessageContent;
...
use orbiterx_protocol::parse_command::ParsedCommand as CoreParsedCommand;
...
use orbiterx_protocol::protocol::GuardianRiskLevel as CoreGuardianRiskLevel;
use orbiterx_protocol::protocol::GuardianUserAuthorization as CoreGuardianUserAuthorization;
use orbiterx_protocol::protocol::PatchApplyStatus as CorePatchApplyStatus;
use orbiterx_protocol::protocol::ReviewDecision as CoreReviewDecision;
...
pub(crate) fn web_search_action_from_core(
    value: orbiterx_protocol::models::WebSearchAction,
) -> WebSearchAction {
    match value {
        orbiterx_protocol::models::WebSearchAction::Search { query, queries } => {
            WebSearchAction::Search { query, queries }
        }
        orbiterx_protocol::models::WebSearchAction::OpenPage { url } => {
            WebSearchAction::OpenPage { url }
        }
        orbiterx_protocol::models::WebSearchAction::FindInPage { url, pattern } => {
            WebSearchAction::FindInPage { url, pattern }
        }
        orbiterx_protocol::models::WebSearchAction::Other => WebSearchAction::Other,
    }
}
...
impl From<orbiterx_protocol::items::HookPromptFragment> for HookPromptFragment {
    fn from(value: orbiterx_protocol::items::HookPromptFragment) -> Self {
        Self {
            text: value.text,
...
impl From<orbiterx_protocol::dynamic_tools::DynamicToolCallOutputContentItem>
    for DynamicToolCallOutputContentItem
{
    fn from(item: orbiterx_protocol::dynamic_tools::DynamicToolCallOutputContentItem) -> Self {
        match item {
...
impl From<DynamicToolCallOutputContentItem>
    for orbiterx_protocol::dynamic_tools::DynamicToolCallOutputContentItem
{
