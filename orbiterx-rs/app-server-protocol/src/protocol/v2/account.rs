...
use orbiterx_protocol::protocol::CreditsSnapshot as CoreCreditsSnapshot;
use orbiterx_protocol::protocol::RateLimitReachedType as CoreRateLimitReachedType;
use orbiterx_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use orbiterx_protocol::protocol::RateLimitWindow as CoreRateLimitWindow;
use orbiterx_protocol::protocol::SpendControlLimitSnapshot as CoreSpendControlLimitSnapshot;
...
pub enum Account {
    ...
    AmazonBedrock {
        #[serde(default)]
        uses_orbiterx_managed_credentials: bool,
    },
}
    ...
    fn from(account: ProviderAccount) -> Self {
        match account {
            ...
            ProviderAccount::AmazonBedrock {
                uses_orbiterx_managed_credentials,
            } => Self::AmazonBedrock {
                uses_orbiterx_managed_credentials,
            },
        }
...
pub enum LoginAccountParams {
    ...
    /// The access token must contain the same scopes that OrbiterX-managed ChatGPT auth tokens have.
    ...
    ChatgptAuthTokens {
        ...
        ///
        /// When `null`, OrbiterX attempts to derive the plan type from access-token
...
pub enum ChatgptAuthTokensRefreshReason {
    /// OrbiterX attempted a backend request and received `401 Unauthorized`.
    Unauthorized,
}
...
pub struct ChatgptAuthTokensRefreshParams {
    ...
    /// Workspace/account identifier that OrbiterX was previously using.
    ///
...
pub struct GetAccountRateLimitsResponse {
    ...
    /// Multi-bucket view keyed by metered `limit_id` (for example, `orbiterx`).
