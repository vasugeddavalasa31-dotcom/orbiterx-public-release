...
use orbiterx_protocol::approvals::ExecPolicyAmendment as CoreExecPolicyAmendment;
use orbiterx_protocol::approvals::NetworkApprovalContext as CoreNetworkApprovalContext;
use orbiterx_protocol::approvals::NetworkApprovalProtocol as CoreNetworkApprovalProtocol;
use orbiterx_protocol::approvals::NetworkPolicyAmendment as CoreNetworkPolicyAmendment;
use orbiterx_protocol::approvals::NetworkPolicyRuleAction as CoreNetworkPolicyRuleAction;
use orbiterx_protocol::models::ActivePermissionProfile as CoreActivePermissionProfile;
...
use orbiterx_protocol::models::LegacyReadWriteRoots;
...
use orbiterx_utils_path_uri::PathConvention;
...
impl SandboxPolicy {
    pub fn to_core(&self) -> orbiterx_protocol::protocol::SandboxPolicy {
        match self {
...
impl From<orbiterx_protocol::protocol::SandboxPolicy> for SandboxPolicy {
    fn from(value: orbiterx_protocol::protocol::SandboxPolicy) -> Self {
        match value {
            orbiterx_protocol::protocol::SandboxPolicy::DangerFullAccess => {
                SandboxPolicy::DangerFullAccess
            }
            orbiterx_protocol::protocol::SandboxPolicy::ReadOnly { network_access } => {
                SandboxPolicy::ReadOnly { network_access }
            }
            orbiterx_protocol::protocol::SandboxPolicy::ExternalSandbox { network_access } => {
