...
use orbiterx_protocol::protocol::SkillDependencies as CoreSkillDependencies;
use orbiterx_protocol::protocol::SkillInterface as CoreSkillInterface;
use orbiterx_protocol::protocol::SkillMetadata as CoreSkillMetadata;
use orbiterx_protocol::protocol::SkillScope as CoreSkillScope;
use orbiterx_protocol::protocol::SkillToolDependency as CoreSkillToolDependency;
...
pub enum PluginAvailability {
    ...
    /// OrbiterX app-server exposes `"AVAILABLE"` in its API; the alias keeps
