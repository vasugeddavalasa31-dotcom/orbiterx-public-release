...
use orbiterx_protocol::protocol::SubAgentSource as CoreSubAgentSource;
use orbiterx_protocol::protocol::ThreadHistoryMode as CoreThreadHistoryMode;
use orbiterx_protocol::protocol::ThreadSource as CoreThreadSource;
...
#[ts(export_to = "v2/")]
pub struct Thread {
    /// Identifier for this thread. OrbiterX-generated thread IDs are UUIDv7.
    pub id: String,
    ...
    /// Origin of the thread (CLI, VSCode, orbiterx exec, orbiterx app-server, etc.).
...
#[ts(export_to = "v2/")]
pub struct Turn {
    /// Identifier for this turn. OrbiterX-generated turn IDs are UUIDv7.
    pub id: String,
