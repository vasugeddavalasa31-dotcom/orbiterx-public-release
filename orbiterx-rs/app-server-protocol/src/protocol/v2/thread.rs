...
pub use orbiterx_protocol::capabilities::CapabilityRootLocation;
pub use orbiterx_protocol::capabilities::SelectedCapabilityRoot;
...
use orbiterx_protocol::protocol::ThreadGoalStatus as CoreThreadGoalStatus;
use orbiterx_protocol::protocol::TokenUsage as CoreTokenUsage;
use orbiterx_protocol::protocol::TokenUsageInfo as CoreTokenUsageInfo;
...
pub struct ThreadStartParams {
    ...
    #[serde(
        default,
        deserialize_with = "orbiterx_protocol::dynamic_tools::deserialize_dynamic_tool_specs"
    )]
    #[ts(optional = nullable)]
    ...
    /// This is for internal use only (e.g. OrbiterX Cloud).
...
pub struct ThreadResumeParams {
    ...
    /// [UNSTABLE] FOR ORBITERX CLOUD - DO NOT USE.
...
impl From<orbiterx_protocol::protocol::ThreadGoal> for ThreadGoal {
    fn from(value: orbiterx_protocol::protocol::ThreadGoal) -> Self {
        Self {
...
impl ThreadMemoryMode {
    ...
    pub fn to_core(self) -> orbiterx_protocol::protocol::ThreadMemoryMode {
        match self {
            Self::Enabled => orbiterx_protocol::protocol::ThreadMemoryMode::Enabled,
            Self::Disabled => orbiterx_protocol::protocol::ThreadMemoryMode::Disabled,
        }
    }
}
...
pub struct ThreadApproveGuardianDeniedActionParams {
    pub thread_id: String,
    /// Serialized `orbiterx_protocol::protocol::GuardianAssessmentEvent`.
    pub event: JsonValue,
}
