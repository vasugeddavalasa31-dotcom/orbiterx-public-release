...
use orbiterx_protocol::protocol::HookEventName as CoreHookEventName;
use orbiterx_protocol::protocol::HookExecutionMode as CoreHookExecutionMode;
use orbiterx_protocol::protocol::HookHandlerType as CoreHookHandlerType;
use orbiterx_protocol::protocol::HookOutputEntry as CoreHookOutputEntry;
use orbiterx_protocol::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use orbiterx_protocol::protocol::HookRunStatus as CoreHookRunStatus;
use orbiterx_protocol::protocol::HookRunSummary as CoreHookRunSummary;
use orbiterx_protocol::protocol::HookScope as CoreHookScope;
use orbiterx_protocol::protocol::HookSource as CoreHookSource;
use orbiterx_protocol::protocol::HookTrustStatus as CoreHookTrustStatus;
