...
use orbiterx_protocol::models::SandboxPermissions;
use orbiterx_protocol::protocol::GuardianAssessmentOutcome;
use orbiterx_protocol::protocol::GuardianCommandSource;
use orbiterx_protocol::protocol::GuardianRiskLevel;
use orbiterx_protocol::protocol::GuardianUserAuthorization;
...
pub(crate) enum TrackEventRequest {
    ...
    AppMentioned(OrbiterXAppMentionedEventRequest),
    AppUsed(OrbiterXAppUsedEventRequest),
    HookRun(OrbiterXHookRunEventRequest),
    Compaction(Box<OrbiterXCompactionEventRequest>),
    Goal(Box<OrbiterXGoalEventRequest>),
    TurnEvent(Box<OrbiterXTurnEventRequest>),
    TurnSteer(OrbiterXTurnSteerEventRequest),
    CommandExecution(OrbiterXCommandExecutionEventRequest),
    FileChange(OrbiterXFileChangeEventRequest),
    McpToolCall(OrbiterXMcpToolCallEventRequest),
    DynamicToolCall(OrbiterXDynamicToolCallEventRequest),
    CollabAgentToolCall(OrbiterXCollabAgentToolCallEventRequest),
    WebSearch(OrbiterXWebSearchEventRequest),
    ImageGeneration(OrbiterXImageGenerationEventRequest),
    AcceptedLineFingerprints(Box<OrbiterXAcceptedLineFingerprintsEventRequest>),
    #[allow(dead_code)]
    ReviewEvent(OrbiterXReviewEventRequest),
    PluginUsed(OrbiterXPluginUsedEventRequest),
    PluginInstallRequested(OrbiterXPluginInstallRequestedEventRequest),
    PluginInstalled(OrbiterXPluginEventRequest),
    PluginUninstalled(OrbiterXPluginEventRequest),
    PluginEnabled(OrbiterXPluginEventRequest),
    PluginDisabled(OrbiterXPluginEventRequest),
    PluginInstallFailed(OrbiterXPluginInstallFailedEventRequest),
    ExternalAgentConfigImportCompleted(OrbiterXOnboardingExternalAgentImportCompleteEventRequest),
    ExternalAgentConfigImportFailure(OrbiterXOnboardingExternalAgentImportFailureEventRequest),
}
...
#[derive(Serialize)]
pub(crate) struct OrbiterXAcceptedLineFingerprintsEventParams {
...
#[derive(Serialize)]
pub(crate) struct OrbiterXAcceptedLineFingerprintsEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: OrbiterXAcceptedLineFingerprintsEventParams,
}
...
pub(crate) struct OrbiterXAppServerClientMetadata {
...
#[derive(Clone, Serialize)]
pub(crate) struct OrbiterXRuntimeMetadata {
    pub(crate) orbiterx_rs_version: String,
...
pub(crate) struct ThreadInitializedEventParams {
    ...
    pub(crate) app_server_client: OrbiterXAppServerClientMetadata,
    pub(crate) runtime: OrbiterXRuntimeMetadata,
...
pub enum GuardianApprovalRequestSource {
    /// Approval requested directly by the main OrbiterX turn.
    MainTurn,
...
#[derive(Serialize)]
pub(crate) struct OrbiterXToolItemEventBase {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
...
#[derive(Serialize)]
pub(crate) struct OrbiterXReviewEventParams {
    pub(crate) thread_id: String,
    pub(crate) turn_id: String,
...
#[derive(Serialize)]
pub(crate) struct OrbiterXReviewEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: OrbiterXReviewEventParams,
}
#[allow(dead_code)]
#[derive(Clone, Copy, Debug, Serialize)]
#[serde(rename_all = "snake_case")]
...
#[derive(Serialize)]
pub(crate) struct OrbiterXCommandExecutionEventParams {
    #[serde(flatten)]
    pub(crate) base: OrbiterXToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct OrbiterXCommandExecutionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: OrbiterXCommandExecutionEventParams,
}

#[derive(Serialize)]
pub(crate) struct OrbiterXFileChangeEventParams {
    #[serde(flatten)]
    pub(crate) base: OrbiterXToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct OrbiterXFileChangeEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: OrbiterXFileChangeEventParams,
}

#[derive(Serialize)]
pub(crate) struct OrbiterXMcpToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: OrbiterXToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct OrbiterXMcpToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: OrbiterXMcpToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct OrbiterXDynamicToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: OrbiterXToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct OrbiterXDynamicToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: OrbiterXDynamicToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct OrbiterXCollabAgentToolCallEventParams {
    #[serde(flatten)]
    pub(crate) base: OrbiterXToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct OrbiterXCollabAgentToolCallEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: OrbiterXCollabAgentToolCallEventParams,
}

#[derive(Serialize)]
pub(crate) struct OrbiterXWebSearchEventParams {
    #[serde(flatten)]
    pub(crate) base: OrbiterXToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct OrbiterXWebSearchEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: OrbiterXWebSearchEventParams,
}

#[derive(Serialize)]
pub(crate) struct OrbiterXImageGenerationEventParams {
    #[serde(flatten)]
    pub(crate) base: OrbiterXToolItemEventBase,
...
#[derive(Serialize)]
pub(crate) struct OrbiterXImageGenerationEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: OrbiterXImageGenerationEventParams,
}

#[derive(Serialize)]
pub(crate) struct OrbiterXAppMetadata {
    pub(crate) connector_id: Option<String>,
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct OrbiterXAppMentionedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: OrbiterXAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct OrbiterXAppUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: OrbiterXAppMetadata,
}

#[derive(Serialize)]
pub(crate) struct OrbiterXHookRunMetadata {
    pub(crate) thread_id: Option<String>,
    pub(crate) turn_id: Option<String>,
    pub(crate) product_client_id: Option<String>,
    pub(crate) model_slug: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct OrbiterXHookRunEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: OrbiterXHookRunMetadata,
}

#[derive(Serialize)]
pub(crate) struct OrbiterXCompactionEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
    pub(crate) app_server_client: OrbiterXAppServerClientMetadata,
    ...
    pub(crate) orbiterx_error_kind: Option<OrbiterXErrKind>,
    pub(crate) orbiterx_error_http_status_code: Option<u16>,
...
#[derive(Serialize)]
pub(crate) struct OrbiterXCompactionEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: OrbiterXCompactionEventParams,
}

#[derive(Serialize)]
pub(crate) struct OrbiterXGoalEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: Option<String>,
    pub(crate) app_server_client: OrbiterXAppServerClientMetadata,
    ...
    pub(crate) goal_status: orbiterx_state::ThreadGoalStatus,
...
#[derive(Serialize)]
pub(crate) struct OrbiterXGoalEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: OrbiterXGoalEventParams,
}

#[derive(Serialize)]
pub(crate) struct OrbiterXTurnEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
    pub(crate) turn_id: String,
    ...
    pub(crate) turn_error: Option<OrbiterXErrorInfo>,
    pub(crate) orbiterx_error_kind: Option<OrbiterXErrKind>,
    pub(crate) orbiterx_error_http_status_code: Option<u16>,
...
#[derive(Serialize)]
pub(crate) struct OrbiterXTurnEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: OrbiterXTurnEventParams,
}

#[derive(Serialize)]
pub(crate) struct OrbiterXTurnSteerEventParams {
    pub(crate) thread_id: String,
    pub(crate) session_id: String,
...
#[derive(Serialize)]
pub(crate) struct OrbiterXTurnSteerEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: OrbiterXTurnSteerEventParams,
}

#[derive(Serialize)]
pub(crate) struct OrbiterXPluginMetadata {
    pub(crate) plugin_id: Option<String>,
...
#[derive(Serialize)]
pub(crate) struct OrbiterXPluginUsedMetadata {
    #[serde(flatten)]
    pub(crate) plugin: OrbiterXPluginMetadata,
...
#[derive(Serialize)]
pub(crate) struct OrbiterXPluginInstallRequestedPluginMetadata {
...
#[derive(Serialize)]
pub(crate) struct OrbiterXPluginInstallRequestedMetadata {
    pub(crate) suggestion_id: String,
    pub(crate) plugins: Vec<OrbiterXPluginInstallRequestedPluginMetadata>,
...
#[derive(Serialize)]
pub(crate) struct OrbiterXPluginInstallRequestedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: OrbiterXPluginInstallRequestedMetadata,
}

#[derive(Serialize)]
pub(crate) struct OrbiterXPluginEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: OrbiterXPluginMetadata,
}

#[derive(Serialize)]
pub(crate) struct OrbiterXPluginInstallFailedMetadata {
    #[serde(flatten)]
    pub(crate) plugin: OrbiterXPluginMetadata,
...
#[derive(Serialize)]
pub(crate) struct OrbiterXPluginInstallFailedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: OrbiterXPluginInstallFailedMetadata,
}

#[derive(Serialize)]
pub(crate) struct OrbiterXOnboardingExternalAgentImportCompleteMetadata {
...
#[derive(Serialize)]
pub(crate) struct OrbiterXOnboardingExternalAgentImportCompleteEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: OrbiterXOnboardingExternalAgentImportCompleteMetadata,
}

#[derive(Serialize)]
pub(crate) struct OrbiterXOnboardingExternalAgentImportFailureMetadata {
    pub(crate) import_id: String,
    pub(crate) source: String,
    #[serde(rename = "type")]
    pub(crate) item_type: String,
...
#[derive(Serialize)]
pub(crate) struct OrbiterXOnboardingExternalAgentImportFailureEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: OrbiterXOnboardingExternalAgentImportFailureMetadata,
}

#[derive(Serialize)]
pub(crate) struct OrbiterXPluginUsedEventRequest {
    pub(crate) event_type: &'static str,
    pub(crate) event_params: OrbiterXPluginUsedMetadata,
}

pub(crate) fn plugin_state_event_type(state: PluginState) -> &'static str {
    match state {
        PluginState::Installed => "orbiterx_plugin_installed",
        PluginState::Uninstalled => "orbiterx_plugin_uninstalled",
        PluginState::Enabled => "orbiterx_plugin_enabled",
        PluginState::Disabled => "orbiterx_plugin_disabled",
    }
}

pub(crate) fn orbiterx_app_metadata(
...
pub(crate) fn orbiterx_plugin_metadata(plugin: PluginTelemetryMetadata) -> OrbiterXPluginMetadata {
    orbiterx_plugin_metadata_with_product_client_id(plugin, originator().value)
}

fn orbiterx_plugin_metadata_with_product_client_id(
    plugin: PluginTelemetryMetadata,
    product_client_id: String,
) -> OrbiterXPluginMetadata {
...
pub(crate) fn orbiterx_plugin_install_requested_metadata(
    tracking: &TrackEventsContext,
    request: PluginInstallRequested,
) -> OrbiterXPluginInstallRequestedMetadata {
    OrbiterXPluginInstallRequestedMetadata {
        suggestion_id: request.suggestion_id,
        plugins: request
            .plugins
            .into_iter()
            .map(|plugin| OrbiterXPluginInstallRequestedPluginMetadata {
...
pub(crate) fn orbiterx_compaction_event_params(
    ...
    OrbiterXCompactionEventParams {
        ...
        status: input.status,
        orbiterx_error_kind: input.orbiterx_error_kind,
        orbiterx_error_http_status_code: input.orbiterx_error_http_status_code,
...
pub(crate) fn orbiterx_goal_event_params(
    input: OrbiterXGoalEvent,
    session_id: String,
    app_server_client: OrbiterXAppServerClientMetadata,
    runtime: OrbiterXRuntimeMetadata,
    thread_source: Option<ThreadSource>,
...
pub(crate) fn orbiterx_plugin_used_metadata(
    tracking: &TrackEventsContext,
    plugin: PluginTelemetryMetadata,
) -> OrbiterXPluginUsedMetadata {
    let mcp_server_names = plugin
        .capability_summary
        .as_ref()
        .map(|summary| summary.mcp_server_names.clone());
    OrbiterXPluginUsedMetadata {
        plugin: orbiterx_plugin_metadata_with_product_client_id(
            plugin,
...
pub(crate) fn orbiterx_hook_run_metadata(
    tracking: &TrackEventsContext,
    hook: HookRunFact,
) -> OrbiterXHookRunMetadata {
    OrbiterXHookRunMetadata {
        thread_id: Some(tracking.thread_id.clone()),
        turn_id: Some(tracking.turn_id.clone()),
        product_client_id: Some(tracking.product_client_id.clone()),
...
pub(crate) fn current_runtime_metadata() -> OrbiterXRuntimeMetadata {
    let os_info = os_info::get();
    OrbiterXRuntimeMetadata {
        orbiterx_rs_version: env!("CARGO_PKG_VERSION").to_string(),
