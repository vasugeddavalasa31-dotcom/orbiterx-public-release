...
use orbiterx_app_server_protocol::RemoteControlDisableParams;
use orbiterx_app_server_protocol::RemoteControlDisableResponse;
use orbiterx_app_server_protocol::RemoteControlEnableParams;
...
async fn connect_with_retry(
    ...
    connect_timeout: Duration,
    connect_retry_delay: Duration,
) -> Result<WebSocketStream<orbiterx_uds::UnixStream>> {
...
mod tests {
    ...
    const TEST_ORBITERX_HOME: &str = "/tmp/orbiterx-home";
        ...
        client::send_message(
            ...
            &JSONRPCMessage::Response(JSONRPCResponse {
                ...
                result: serde_json::json!({
                    "userAgent": "orbiterx_app_server/1.2.3",
                    "orbiterxHome": TEST_ORBITERX_HOME,
                    "platformFamily": "unix",
                    "platformOs": "macos",
                }),
            }),
