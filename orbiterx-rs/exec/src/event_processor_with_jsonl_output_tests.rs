...
fn failed_turn_does_not_overwrite_output_last_message_file() {
    ...
    let status = processor.process_server_notification(ServerNotification::TurnCompleted(
        orbiterx_app_server_protocol::TurnCompletedNotification {
            ...
            turn: orbiterx_app_server_protocol::Turn {
                ...
                error: Some(orbiterx_app_server_protocol::TurnError {
    ...
    assert_eq!(status, OrbiterXStatus::InitiateShutdown);
    ...
    let collected = processor.collect_thread_events(ServerNotification::ItemCompleted(
        orbiterx_app_server_protocol::ItemCompletedNotification {
            item: ThreadItem::McpToolCall {
                ...
                arguments: json!({"search_query": [{"q": "OpenAI OrbiterX CLI documentation"}]}),
                app_context: None,
                mcp_app_resource_uri: None,
                plugin_id: None,
                result: Some(Box::new(orbiterx_app_server_protocol::McpToolCallResult {
