...
pub const ORBITERX_OPEN_APP_URL: &str = "https://chatgpt.com/orbiterx/open-app";
...
pub(crate) fn compose_success_url(
    ...
    if orbiterx_streamlined_login {
        params.push(("orbiterx_streamlined_login", "true".to_string()));
    }
    let query = params
        .into_iter()
