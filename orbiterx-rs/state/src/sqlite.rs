...
/// Resolved configuration shared by all OrbiterX SQLite connections.
...
impl SqliteConfig {
    ...
    /// Open a writable OrbiterX SQLite database, creating it if necessary.
    ...
    /// Open an existing OrbiterX SQLite database without creating or modifying it.
