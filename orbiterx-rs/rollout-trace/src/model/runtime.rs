...
/// Runtime operation requested by the model, a JS code cell, or OrbiterX itself.
///
...
pub struct ToolCall {
    ...
    pub started_by_orbiterx_turn_id: Option<OrbiterXTurnId>,
    pub execution: ExecutionWindow,
    ...
    /// Original invocation at the OrbiterX tool boundary.
    ///
    ...
    /// they describe how OrbiterX executed the request, not what the caller sent.
