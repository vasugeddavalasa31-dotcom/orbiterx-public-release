...
/// OrbiterX conversation/session UUID.
...
pub type OrbiterXTurnId = String;
...
/// Process/session ID returned by OrbiterX's terminal runtime.
...
/// Canonical reduced graph for one OrbiterX rollout.
#[derive(Debug, Clone, PartialEq, Serialize, Deserialize)]
pub struct RolloutTrace {
    pub schema_version: u32,
    /// Unique identity for this trace capture.
    ///
    /// `rollout_id` names the OrbiterX rollout/session being observed. `trace_id`
    ...
    pub orbiterx_turns: BTreeMap<OrbiterXTurnId, OrbiterXTurn>,
