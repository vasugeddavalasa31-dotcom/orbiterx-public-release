...
pub struct RawTraceEvent {
    ...
    pub orbiterx_turn_id: Option<OrbiterXTurnId>,
...
pub enum RawTraceEventPayload {
    ...
    InferenceCancelled {
        ...
        /// before OrbiterX stopped consuming the stream.
        upstream_request_id: Option<String>,
        /// Why OrbiterX stopped consuming the provider stream before a terminal response event.
        reason: String,
    ...
    ToolCallRuntimeStarted {
        tool_call_id: ToolCallId,
        /// Runtime/protocol observation for how OrbiterX began executing the tool.
        runtime_payload: RawPayloadRef,
    },
    ToolCallRuntimeEnded {
        tool_call_id: ToolCallId,
        status: ExecutionStatus,
        /// Runtime/protocol observation for how OrbiterX finished executing the tool.
        runtime_payload: RawPayloadRef,
    },
    ToolCallEnded {
        tool_call_id: ToolCallId,
    ...
    AgentResultObserved {
        ...
        child_orbiterx_turn_id: OrbiterXTurnId,
...
impl RawTraceEventPayload {
    ...
    pub(crate) fn raw_payload_refs(&self) -> Vec<&RawPayloadRef> {
        match self {
            ...
            | RawTraceEventPayload::OrbiterXTurnEnded { .. }
