//! Trace bundle format, writer, and reducer for OrbiterX rollouts.
//!
//! This crate owns the trace schema. Hot-path OrbiterX code should depend on the
...
/// Shared recorder context for inference attempts within one OrbiterX turn.
...
pub use thread::ORBITERX_ROLLOUT_TRACE_ROOT_ENV;
...
/// Request data for the canonical OrbiterX tool boundary.
...
/// Append-only writer used by hot-path OrbiterX instrumentation.
