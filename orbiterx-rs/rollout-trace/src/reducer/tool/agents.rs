...
use anyhow::Result;
use anyhow::bail;
use orbiterx_protocol::protocol::CollabAgentInteractionBeginEvent;
use orbiterx_protocol::protocol::CollabAgentInteractionEndEvent;
use orbiterx_protocol::protocol::CollabAgentSpawnEndEvent;
use orbiterx_protocol::protocol::CollabCloseBeginEvent;
use orbiterx_protocol::protocol::CollabCloseEndEvent;
...
pub(in crate::reducer) struct ObservedAgentResultEdge {
    ...
    pub(in crate::reducer) child_orbiterx_turn_id: String,
...
impl TraceReducer {
    ...
    pub(in crate::reducer) fn queue_agent_result_interaction_edge(
        ...
        let source = if let Some(source_item_id) = self.latest_assistant_message_item_for_turn(
            ...
            &observed.child_orbiterx_turn_id,
        ) {
        ...
        self.rollout
            ...
            .filter(|item| {
                item.thread_id == thread_id
                    && item.orbiterx_turn_id.as_deref() == Some(orbiterx_turn_id)
