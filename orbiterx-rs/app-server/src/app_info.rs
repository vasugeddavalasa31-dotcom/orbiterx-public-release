use orbiterx_app_server_protocol::AppBranding as ApiAppBranding;
use orbiterx_app_server_protocol::AppInfo as ApiAppInfo;
use orbiterx_app_server_protocol::AppMetadata as ApiAppMetadata;
use orbiterx_app_server_protocol::AppReview as ApiAppReview;
use orbiterx_app_server_protocol::AppScreenshot as ApiAppScreenshot;
use orbiterx_app_server_protocol::AppToolSummary as ApiAppToolSummary;
use orbiterx_app_server_protocol::ConnectorMetadata as ApiConnectorMetadata;
use orbiterx_connectors::AppBranding;
use orbiterx_connectors::AppInfo;
use orbiterx_connectors::AppMetadata;
use orbiterx_connectors::AppReview;
use orbiterx_connectors::AppScreenshot;
use orbiterx_connectors::ConnectorMetadata;
use orbiterx_connectors::ConnectorToolSummary;

/// Converts connector-domain app metadata owned by `orbiterx-connectors` into the app-server wire
/// type owned by `orbiterx-app-server-protocol`.
///
