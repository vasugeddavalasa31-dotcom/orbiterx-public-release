...
use orbiterx_app_server_protocol::AccountRateLimitsUpdatedNotification;
use orbiterx_app_server_protocol::AdditionalPermissionProfile as V2AdditionalPermissionProfile;
use orbiterx_app_server_protocol::CommandAction as V2ParsedCommand;
...
use orbiterx_app_server_protocol::DynamicToolCallParams;
use orbiterx_app_server_protocol::EnvironmentConnectionNotification;
use orbiterx_app_server_protocol::ErrorNotification;
use orbiterx_app_server_protocol::ExecPolicyAmendment as V2ExecPolicyAmendment;
use orbiterx_app_server_protocol::FileChangeApprovalDecision;
use orbiterx_app_server_protocol::FileChangeRequestApprovalParams;
use orbiterx_app_server_protocol::FileChangeRequestApprovalResponse;
use orbiterx_app_server_protocol::GrantedPermissionProfile as V2GrantedPermissionProfile;
use orbiterx_app_server_protocol::GuardianWarningNotification;
use orbiterx_app_server_protocol::HookCompletedNotification;
use orbiterx_app_server_protocol::HookStartedNotification;
use orbiterx_app_server_protocol::ItemCompletedNotification;
use orbiterx_app_server_protocol::ItemStartedNotification;
use orbiterx_app_server_protocol::McpServerElicitationAction;
use orbiterx_app_server_protocol::McpServerElicitationRequestParams;
use orbiterx_app_server_protocol::McpServerElicitationRequestResponse;
use orbiterx_app_server_protocol::McpServerStartupState;
use orbiterx_app_server_protocol::McpServerStatusUpdatedNotification;
use orbiterx_app_server_protocol::ModelReroutedNotification;
use orbiterx_app_server_protocol::ModelSafetyBufferingUpdatedNotification;
use orbiterx_app_server_protocol::ModelVerificationNotification;
use orbiterx_app_server_protocol::NetworkApprovalContext as V2NetworkApprovalContext;
use orbiterx_app_server_protocol::NetworkPolicyAmendment as V2NetworkPolicyAmendment;
use orbiterx_app_server_protocol::NetworkPolicyRuleAction as V2NetworkPolicyRuleAction;
use orbiterx_app_server_protocol::OrbiterXErrorInfo as V2OrbiterXErrorInfo;
use orbiterx_app_server_protocol::PermissionsRequestApprovalParams;
use orbiterx_app_server_protocol::PermissionsRequestApprovalResponse;
use orbiterx_app_server_protocol::RawResponseCompletedNotification;
use orbiterx_app_server_protocol::RawResponseItemCompletedNotification;
...
use orbiterx_app_server_protocol::ThreadRealtimeClosedNotification;
use orbiterx_app_server_protocol::ThreadRealtimeErrorNotification;
use orbiterx_app_server_protocol::ThreadRealtimeItemAddedNotification;
use orbiterx_app_server_protocol::ThreadRealtimeOutputAudioDeltaNotification;
use orbiterx_app_server_protocol::ThreadRealtimeSdpNotification;
use orbiterx_app_server_protocol::ThreadRealtimeStartedNotification;
use orbiterx_app_server_protocol::ThreadRealtimeTranscriptDeltaNotification;
use orbiterx_app_server_protocol::ThreadRealtimeTranscriptDoneNotification;
use orbiterx_app_server_protocol::ThreadRollbackResponse;
use orbiterx_app_server_protocol::ThreadSettingsUpdatedNotification;
use orbiterx_app_server_protocol::ThreadStatus;
use orbiterx_app_server_protocol::ThreadTokenUsage;
use orbiterx_app_server_protocol::ThreadTokenUsageUpdatedNotification;
use orbiterx_app_server_protocol::ToolRequestUserInputOption;
use orbiterx_app_server_protocol::ToolRequestUserInputParams;
use orbiterx_app_server_protocol::ToolRequestUserInputQuestion;
use orbiterx_app_server_protocol::ToolRequestUserInputResponse;
...
use orbiterx_app_server_protocol::TurnModerationMetadataNotification;
...
use orbiterx_app_server_protocol::WarningNotification;
use orbiterx_app_server_protocol::build_item_from_guardian_event;
use orbiterx_app_server_protocol::guardian_auto_approval_review_notification;
use orbiterx_app_server_protocol::item_event_to_server_notification;
use orbiterx_core::OrbiterXThread;
use orbiterx_core::ThreadManager;
use orbiterx_protocol::ThreadId;
use orbiterx_protocol::items::CollabAgentTool as CoreCollabAgentTool;
use orbiterx_protocol::items::TurnItem as CoreTurnItem;
use orbiterx_protocol::models::AdditionalPermissionProfile as CoreAdditionalPermissionProfile;
use orbiterx_protocol::plan_tool::UpdatePlanArgs;
use orbiterx_protocol::protocol::Event;
use orbiterx_protocol::protocol::EventMsg;
use orbiterx_protocol::protocol::ExecApprovalRequestEvent;
use orbiterx_protocol::protocol::Op;
use orbiterx_protocol::protocol::OrbiterXErrorInfo as CoreOrbiterXErrorInfo;
use orbiterx_protocol::protocol::RealtimeEvent;
...
use orbiterx_protocol::protocol::TurnDiffEvent;
...
use orbiterx_protocol::request_user_input::RequestUserInputAnswer as CoreRequestUserInputAnswer;
use orbiterx_protocol::request_user_input::RequestUserInputResponse as CoreRequestUserInputResponse;
use orbiterx_sandboxing::policy_transforms::intersect_permission_profiles;
use orbiterx_shell_command::parse_command::shlex_join;
    ...
    match msg {
        ...
        EventMsg::McpStartupUpdate(update) => {
            let (status, error, failure_reason) = match update.status {
                orbiterx_protocol::protocol::McpStartupStatus::Starting => {
                    (McpServerStartupState::Starting, None, None)
                }
                orbiterx_protocol::protocol::McpStartupStatus::Ready => {
                    (McpServerStartupState::Ready, None, None)
                }
                orbiterx_protocol::protocol::McpStartupStatus::Failed { error, reason } => (
                    McpServerStartupState::Failed,
                    Some(error),
                    reason.map(Into::into),
                ),
                orbiterx_protocol::protocol::McpStartupStatus::Cancelled => {
        ...
        EventMsg::GuardianAssessment(assessment) => {
            ...
            if assessment.status
                == orbiterx_protocol::protocol::GuardianAssessmentStatus::InProgress
            ...
            let completion_status = match assessment.status {
                orbiterx_protocol::protocol::GuardianAssessmentStatus::Denied
                | orbiterx_protocol::protocol::GuardianAssessmentStatus::Aborted => {
                    Some(CommandExecutionStatus::Declined)
                }
                orbiterx_protocol::protocol::GuardianAssessmentStatus::TimedOut => {
                    Some(CommandExecutionStatus::Failed)
                }
                orbiterx_protocol::protocol::GuardianAssessmentStatus::InProgress
                | orbiterx_protocol::protocol::GuardianAssessmentStatus::Approved => None,
            };
                ...
                Err(err) => {
                    ...
                    if let Err(err) = conversation
                        .submit(Op::ResolveElicitation {
                            ...
                            request_id: request.id,
                            decision: orbiterx_protocol::approvals::ElicitationAction::Cancel,
                            content: None,
                            meta: None,
                        })
                        .await
        ...
        EventMsg::Error(ev) => {
            ...
            let orbiterx_error_info = ev.orbiterx_error_info.clone();
            ...
            if matches!(
                orbiterx_error_info,
                Some(CoreOrbiterXErrorInfo::ThreadRollbackFailed)
            ) {
            ...
            let turn_error = TurnError {
                message: ev.message,
                orbiterx_error_info: ev.orbiterx_error_info.map(V2OrbiterXErrorInfo::from),
...
async fn maybe_emit_raw_response_item_completed(
    conversation_id: ThreadId,
    turn_id: &str,
    item: orbiterx_protocol::models::ResponseItem,
    outgoing: &ThreadScopedOutgoingMessageSender,
) {
...
fn thread_rollback_response_from_stored_thread(
    stored_thread: orbiterx_thread_store::StoredThread,
    session_id: String,
...
async fn on_mcp_server_elicitation_response(
    server_name: String,
    request_id: orbiterx_protocol::mcp::RequestId,
    pending_request_id: RequestId,
    receiver: oneshot::Receiver<ClientRequestResult>,
    conversation: Arc<OrbiterXThread>,
    thread_state: Arc<Mutex<ThreadState>>,
...
fn request_permissions_response_from_client_result(
    ...
    let response = serde_json::from_value::<PermissionsRequestApprovalResponse>(value)
        .unwrap_or_else(|err| {
            ...
            PermissionsRequestApprovalResponse {
                ...
                scope: orbiterx_app_server_protocol::PermissionGrantScope::Turn,
    ...
    if strict_auto_review
        && matches!(
            response.scope,
            orbiterx_app_server_protocol::PermissionGrantScope::Session
        )
    {
...
mod tests {
    ...
    use orbiterx_app_server_protocol::AutoReviewDecisionSource;
    ...
    use orbiterx_protocol::items::DynamicToolCallItem;
    use orbiterx_protocol::items::DynamicToolCallStatus as CoreDynamicToolCallStatus;
    use orbiterx_protocol::items::SubAgentActivityItem;
    use orbiterx_protocol::items::TurnItem as CoreTurnItem;
    use orbiterx_protocol::models::FileSystemPermissions as CoreFileSystemPermissions;
    ...
    use orbiterx_protocol::plan_tool::PlanItemArg;
    use orbiterx_protocol::plan_tool::StepStatus;
    use orbiterx_protocol::protocol::AgentMessageEvent;
    use orbiterx_protocol::protocol::AskForApproval;
    use orbiterx_protocol::protocol::CreditsSnapshot;
    use orbiterx_protocol::protocol::EventMsg;
    use orbiterx_protocol::protocol::GuardianAssessmentEvent;
    use orbiterx_protocol::protocol::GuardianAssessmentStatus;
    use orbiterx_protocol::protocol::ItemCompletedEvent;
    use orbiterx_protocol::protocol::ItemStartedEvent;
    ...
    use orbiterx_thread_store::StoredThreadHistory;
    use orbiterx_utils_absolute_path::AbsolutePathBuf;
    ...
    fn turn_aborted_event(turn_id: &str) -> TurnAbortedEvent {
        TurnAbortedEvent {
            ...
            started_at: None,
            reason: orbiterx_protocol::protocol::TurnAbortReason::Interrupted,
            completed_at: Some(TEST_TURN_COMPLETED_AT),
            duration_ms: Some(TEST_TURN_DURATION_MS),
        }
    }
    ...
    fn guardian_command_assessment(
        ...
        let (risk_level, user_authorization, rationale) = match status {
            ...
            GuardianAssessmentStatus::Approved => (
                Some(orbiterx_protocol::protocol::GuardianRiskLevel::Low),
                Some(orbiterx_protocol::protocol::GuardianUserAuthorization::High),
                Some("looks safe".to_string()),
            ),
            GuardianAssessmentStatus::Denied => (
                Some(orbiterx_protocol::protocol::GuardianRiskLevel::High),
                Some(orbiterx_protocol::protocol::GuardianUserAuthorization::Low),
        ...
        GuardianAssessmentEvent {
            ...
            decision_source: if matches!(status, GuardianAssessmentStatus::InProgress) {
                ...
                Some(orbiterx_protocol::protocol::GuardianAssessmentDecisionSource::Agent)
            },
    ...
    fn guardian_assessment_started_uses_event_turn_id_fallback() {
        ...
        let action = orbiterx_protocol::protocol::GuardianAssessmentAction::Command {
            source: orbiterx_protocol::protocol::GuardianCommandSource::Shell,
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: orbiterx_protocol::protocol::GuardianAssessmentStatus::InProgress,
                risk_level: None,
    ...
    fn guardian_assessment_completed_emits_review_payload() {
        ...
        let notification = guardian_auto_approval_review_notification(
            ...
            &GuardianAssessmentEvent {
                ...
                status: orbiterx_protocol::protocol::GuardianAssessmentStatus::Denied,
                risk_level: Some(orbiterx_protocol::protocol::GuardianRiskLevel::High),
                user_authorization: Some(
                    orbiterx_protocol::protocol::GuardianUserAuthorization::Low,
                ),
                rationale: Some("too risky".to_string()),
                decision_source: Some(
                    orbiterx_protocol::protocol::GuardianAssessmentDecisionSource::Agent,
                ),
                action: action.clone(),
            },
        );
        ...
        match notification {
            ServerNotification::ItemGuardianApprovalReviewCompleted(payload) => {
                ...
                assert_eq!(
                    ...
                    Some(orbiterx_app_server_protocol::GuardianRiskLevel::High)
                );
                assert_eq!(
                    payload.review.user_authorization,
                    Some(orbiterx_app_server_protocol::GuardianUserAuthorization::Low)
                );
    ...
    fn guardian_assessment_aborted_emits_completed_review_payload() {
        let conversation_id = ThreadId::new();
        let action = orbiterx_protocol::protocol::GuardianAssessmentAction::NetworkAccess {
            target: "api.openai.com:443".to_string(),
            host: "api.openai.com".to_string(),
            protocol: orbiterx_protocol::protocol::NetworkApprovalProtocol::Https,
            port: 443,
        };
        let notification = guardian_auto_approval_review_notification(
            &conversation_id,
            ...
            &GuardianAssessmentEvent {
                ...
                started_at_ms: 1_000,
                completed_at_ms: Some(1_042),
                status: orbiterx_protocol::protocol::GuardianAssessmentStatus::Aborted,
                risk_level: None,
                user_authorization: None,
                rationale: None,
                decision_source: Some(
    ...
    async fn command_execution_started_helper_emits_once() -> Result<()> {
        ...
        let outgoing = Arc::new(OutgoingMessageSender::new(
            tx,
            orbiterx_analytics::AnalyticsEventsClient::disabled(),
        ));
    ...
    async fn guardian_command_execution_notifications_wrap_review_lifecycle() -> Result<()> {
        ...
        let config = load_default_config_for_test(&orbiterx_home).await;
        let thread_manager = Arc::new(
            orbiterx_core::test_support::thread_manager_with_models_provider_and_home(
                OrbiterXAuth::create_dummy_chatgpt_auth_for_testing(),
                config.model_provider.clone(),
                config.orbiterx_home.to_path_buf(),
                Arc::new(orbiterx_exec_server::EnvironmentManager::default_for_tests()),
            ),
        );
        let orbiterx_core::NewThread {
    ...
    async fn test_handle_error_records_message() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                orbiterx_error_info: Some(V2OrbiterXErrorInfo::InternalServerError),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn turn_started_omits_active_snapshot_items() -> Result<()> {
        ...
        let thread_state = new_thread_state();
        {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::TurnStarted(orbiterx_protocol::protocol::TurnStartedEvent {
            ...
            state.track_current_turn_event(
                "turn-1",
                &EventMsg::UserMessage(orbiterx_protocol::protocol::UserMessageEvent {
                    client_id: None,
        ...
        apply_bespoke_event_handling(
            Event {
                id: "turn-1".to_string(),
                msg: EventMsg::TurnStarted(orbiterx_protocol::protocol::TurnStartedEvent {
                    turn_id: "turn-1".to_string(),
                    trace_id: None,
                    started_at: Some(42),
                    model_context_window: None,
        ...
        assert_eq!(
            ...
            ItemCompletedNotification {
                item: ThreadItem::SubAgentActivity {
                    id: "activity-1".to_string(),
                    kind: orbiterx_app_server_protocol::SubAgentActivityKind::Interrupted,
    ...
    async fn test_handle_turn_complete_emits_failed_with_error() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                orbiterx_error_info: Some(V2OrbiterXErrorInfo::Other),
                additional_details: None,
            },
            &thread_state,
        )
    ...
    async fn test_handle_token_count_event_emits_usage_and_rate_limits() -> Result<()> {
        ...
        match second {
            ServerNotification::AccountRateLimitsUpdated(payload) => {
                assert_eq!(payload.rate_limits.limit_id.as_deref(), Some("orbiterx"));
    ...
    async fn test_handle_turn_complete_emits_error_multiple_turns() -> Result<()> {
        ...
        handle_error(
            ...
            TurnError {
                ...
                orbiterx_error_info: Some(V2OrbiterXErrorInfo::BadRequest),
                additional_details: None,
            },
            &thread_state,
        )
