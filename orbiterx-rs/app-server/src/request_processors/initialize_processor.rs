...
use orbiterx_login::default_client::SetOriginatorError;
...
const NON_ORIGINATING_CLIENT_NAMES: &[&str] = &["orbiterx_app_server_daemon", "orbiterx-backend"];
            ...
            if let Err(error) = set_default_originator(originator.clone()) {
                match error {
                    ...
                    SetOriginatorError::AlreadyInitialized => {
                        ...
                        // TODO(owen): Once we remove support for ORBITERX_INTERNAL_ORIGINATOR_OVERRIDE,
