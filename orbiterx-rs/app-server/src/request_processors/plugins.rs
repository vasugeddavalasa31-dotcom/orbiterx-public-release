...
use orbiterx_analytics::PluginInstallSource;
use orbiterx_app_server_protocol::PluginAvailability;
use orbiterx_app_server_protocol::PluginInstallPolicy;
use orbiterx_app_server_protocol::PluginSharePrincipalRole;
use orbiterx_app_server_protocol::PluginShareTargetRole;
use orbiterx_config::types::McpServerConfig;
use orbiterx_core_plugins::OPENAI_CURATED_MARKETPLACE_NAME;
use orbiterx_core_plugins::PluginListBackgroundTaskOptions;
use orbiterx_core_plugins::is_openai_curated_marketplace_name;
use orbiterx_core_plugins::remote::REMOTE_CREATED_BY_ME_MARKETPLACE_NAME;
use orbiterx_core_plugins::remote::REMOTE_GLOBAL_MARKETPLACE_NAME;
use orbiterx_core_plugins::remote::REMOTE_WORKSPACE_MARKETPLACE_NAME;
use orbiterx_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_MARKETPLACE_NAME;
use orbiterx_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_PRIVATE_MARKETPLACE_NAME;
use orbiterx_core_plugins::remote::REMOTE_WORKSPACE_SHARED_WITH_ME_UNLISTED_MARKETPLACE_NAME;
use orbiterx_core_plugins::remote::RemoteAppTemplateUnavailableReason;
use orbiterx_core_plugins::remote::is_valid_remote_plugin_id;
use orbiterx_core_plugins::remote::validate_remote_plugin_id;
use orbiterx_core_plugins::remote_bundle::RemotePluginBundleInstallError;
use orbiterx_mcp::McpOAuthLoginSupport;
use orbiterx_mcp::oauth_login_support;
use orbiterx_mcp::should_retry_without_scopes;
use orbiterx_plugin::PluginId;
use orbiterx_plugin::PluginTelemetryMetadata;
use orbiterx_protocol::auth::AuthMode as DomainAuthMode;
use orbiterx_rmcp_client::perform_oauth_login_silent;
...
pub(crate) struct PluginRequestProcessor {
    ...
    on_effective_plugins_changed:
        Arc<dyn Fn(orbiterx_core_plugins::EffectivePluginsChange) + Send + Sync>,
}

fn plugin_skills_to_info(
    skills: &[orbiterx_core::skills::SkillMetadata],
    ...
    skills
        ...
        .map(|skill| SkillSummary {
            ...
            interface: skill.interface.clone().map(|interface| {
                orbiterx_app_server_protocol::SkillInterface {
...
fn load_shared_plugin_ids_by_local_path(
    ...
    orbiterx_core_plugins::remote::load_plugin_share_remote_ids_by_local_path(
...
fn convert_configured_marketplace_plugin_to_plugin_summary(
    plugin: orbiterx_core_plugins::ConfiguredMarketplacePlugin,
    shared_plugin_ids_by_local_path: &std::collections::BTreeMap<AbsolutePathBuf, String>,
) -> PluginSummary {
...
) -> orbiterx_core_plugins::remote::RemotePluginShareDiscoverability {
    match discoverability {
        PluginShareDiscoverability::Listed => {
            orbiterx_core_plugins::remote::RemotePluginShareDiscoverability::Listed
        }
        PluginShareDiscoverability::Unlisted => {
            orbiterx_core_plugins::remote::RemotePluginShareDiscoverability::Unlisted
        }
        PluginShareDiscoverability::Private => {
            orbiterx_core_plugins::remote::RemotePluginShareDiscoverability::Private
        }
    }
}
...
) -> orbiterx_core_plugins::remote::RemotePluginShareUpdateDiscoverability {
    match discoverability {
        PluginShareUpdateDiscoverability::Listed => {
            orbiterx_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Listed
        }
        PluginShareUpdateDiscoverability::Unlisted => {
            orbiterx_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Unlisted
        }
        PluginShareUpdateDiscoverability::Private => {
            orbiterx_core_plugins::remote::RemotePluginShareUpdateDiscoverability::Private
        }
    }
}
...
) -> orbiterx_core_plugins::remote::RemotePluginShareTargetRole {
    match role {
        PluginShareTargetRole::Reader => {
            orbiterx_core_plugins::remote::RemotePluginShareTargetRole::Reader
        }
        PluginShareTargetRole::Editor => {
            orbiterx_core_plugins::remote::RemotePluginShareTargetRole::Editor
        }
    }
}

fn plugin_share_principal_role_from_remote(
    role: orbiterx_core_plugins::remote::RemotePluginSharePrincipalRole,
) -> PluginSharePrincipalRole {
    match role {
        orbiterx_core_plugins::remote::RemotePluginSharePrincipalRole::Reader => {
            PluginSharePrincipalRole::Reader
        }
        orbiterx_core_plugins::remote::RemotePluginSharePrincipalRole::Editor => {
            PluginSharePrincipalRole::Editor
        }
        orbiterx_core_plugins::remote::RemotePluginSharePrincipalRole::Owner => {
...
) -> Vec<orbiterx_core_plugins::remote::RemotePluginShareTarget> {
    targets
        .into_iter()
        .map(
            |target| orbiterx_core_plugins::remote::RemotePluginShareTarget {
                principal_type: match target.principal_type {
                    PluginSharePrincipalType::User => {
                        orbiterx_core_plugins::remote::RemotePluginSharePrincipalType::User
                    }
                    PluginSharePrincipalType::Group => {
                        orbiterx_core_plugins::remote::RemotePluginSharePrincipalType::Group
                    }
                    PluginSharePrincipalType::Workspace => {
                        orbiterx_core_plugins::remote::RemotePluginSharePrincipalType::Workspace
                    }
                },
...
fn plugin_share_principal_from_remote(
    principal: orbiterx_core_plugins::remote::RemotePluginSharePrincipal,
...
impl PluginRequestProcessor {
    pub(crate) fn new(
        ...
        on_effective_plugins_changed: Arc<
            dyn Fn(orbiterx_core_plugins::EffectivePluginsChange) + Send + Sync,
        >,
    ) -> Self {
        Self {
            auth_manager,
    ...
    async fn workspace_orbiterx_plugins_enabled(
        &self,
        config: &Config,
        auth: Option<&OrbiterXAuth>,
    ) -> bool {
        match workspace_settings::orbiterx_plugins_enabled_for_workspace(
            config,
            auth,
        ...
        .await
        {
            ...
            Err(err) => {
                warn!(
                    "failed to fetch workspace OrbiterX plugins setting; allowing OrbiterX plugins: {err:#}"
                );
                true
            }
        }
    ...
    async fn plugin_list_response(
        ...
        if !self
            .workspace_orbiterx_plugins_enabled(&config, auth.as_ref())
            .await
        {
            return Ok(empty_response());
        }
        let auth_mode = auth.as_ref().map(OrbiterXAuth::api_auth_mode);
        ...
        let use_remote_global_catalog =
            include_global_remote && auth_mode.is_some_and(DomainAuthMode::uses_orbiterx_backend);
        let remote_plugin_service_config = RemotePluginServiceConfig {
            chatgpt_base_url: config.chatgpt_base_url.clone(),
        };
        let refresh_global_remote_catalog_cache = use_remote_global_catalog
            && orbiterx_core_plugins::remote::has_cached_global_remote_plugin_catalog(
                config.orbiterx_home.as_path(),
            ...
            match tokio::task::spawn_blocking(move || {
                ...
                Ok::<
                    (
                        ...
                        Vec<orbiterx_app_server_protocol::MarketplaceLoadErrorInfo>,
                    ),
                    MarketplaceError,
                >((
                    outcome
                    ...
                    outcome
                        ...
                        .into_iter()
                        .map(
                            |err| orbiterx_app_server_protocol::MarketplaceLoadErrorInfo {
        ...
        if include_vertical && !config.features.enabled(Feature::RemotePlugin) {
            match orbiterx_core_plugins::remote::fetch_openai_curated_remote_collection_marketplace(
                &remote_plugin_service_config,
                auth.as_ref(),
            )
            .await
        ...
        if !remote_sources.is_empty() {
            match orbiterx_core_plugins::remote::fetch_remote_marketplaces(
                &remote_plugin_service_config,
                auth.as_ref(),
                &remote_sources,
                /*global_catalog_cache_path*/ Some(config.orbiterx_home.as_path()),
            )
            .await
            {
    ...
    async fn plugin_installed_response(
        ...
        plugins_manager.set_auth_mode(auth.as_ref().map(OrbiterXAuth::api_auth_mode));
    ...
    async fn load_local_installed_and_suggested_plugins(
        &self,
        plugins_manager: Arc<orbiterx_core_plugins::PluginsManager>,
        config: &Config,
        plugins_input: &orbiterx_core_plugins::PluginsConfigInput,
    ...
    async fn plugin_read_response(
        ...
        let plugin = match read_source {
            Ok(marketplace_path) => {
                ...
                let share_context = match share_context {
                    Some(context) => {
                        ...
                        match orbiterx_core_plugins::remote::fetch_remote_plugin_share_context(
                            &remote_plugin_service_config,
                            auth.as_ref(),
                ...
                PluginDetail {
                    ...
                    hooks: outcome
                        ...
                        .hooks
                        .into_iter()
                        .map(|hook| orbiterx_app_server_protocol::PluginHookSummary {
                            key: hook.key,
            ...
            Err(remote_marketplace_name) => {
                ...
                let remote_detail = orbiterx_core_plugins::remote::fetch_remote_plugin_detail(
                    &remote_plugin_service_config,
                    auth.as_ref(),
                    &remote_marketplace_name,
                    &plugin_name,
                ...
                let plugin_apps = remote_detail
                    ...
                    .iter()
                    .cloned()
                    .map(orbiterx_plugin::AppConnectorId)
                    .collect::<Vec<_>>();
    ...
    async fn plugin_skill_read_response(
        ...
        let remote_skill_detail = orbiterx_core_plugins::remote::fetch_remote_plugin_skill_detail(
            &remote_plugin_service_config,
            auth.as_ref(),
            &remote_marketplace_name,
            &remote_plugin_id,
    ...
    async fn plugin_share_save_response(
        ...
        let access_policy = orbiterx_core_plugins::remote::RemotePluginShareAccessPolicy {
        ...
        let result = orbiterx_core_plugins::remote::save_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.orbiterx_home.as_path(),
            &plugin_path,
    ...
    async fn plugin_share_update_targets_response(
        ...
        let result = orbiterx_core_plugins::remote::update_remote_plugin_share_targets(
            &remote_plugin_service_config,
            auth.as_ref(),
            &remote_plugin_id,
    ...
    async fn plugin_share_list_response(
        ...
        let data = orbiterx_core_plugins::remote::list_remote_plugin_shares(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.orbiterx_home.as_path(),
        )
    ...
    async fn plugin_share_checkout_response(
        ...
        let result = orbiterx_core_plugins::remote::checkout_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.orbiterx_home.as_path(),
            &remote_plugin_id,
    ...
    async fn plugin_share_delete_response(
        ...
        orbiterx_core_plugins::remote::delete_remote_plugin_share(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.orbiterx_home.as_path(),
            &remote_plugin_id,
    ...
    async fn load_plugin_share_config_and_auth(
        &self,
    ) -> Result<(Config, Option<OrbiterXAuth>), JSONRPCErrorError> {
        let config = self.load_latest_config(/*fallback_cwd*/ None).await?;
        if !config.features.enabled(Feature::Plugins) {
    ...
    async fn plugin_install_response(
        ...
        {
            return Err(invalid_request(
                "OrbiterX plugins are disabled for this workspace",
            ));
        }
        ...
        let plugin_mcp_servers = load_plugin_mcp_servers(
            ...
            auth.as_ref().map(OrbiterXAuth::auth_mode),
        )
        .await;
        ...
        let plugin_apps =
            orbiterx_plugin::app_connector_ids_from_declarations(&plugin_app_declarations);
        let apps_needing_auth = self
            .plugin_apps_needing_auth_for_install(
                &config,
                auth.as_ref().is_some_and(OrbiterXAuth::is_chatgpt_auth),
    ...
    async fn remote_plugin_install_response(
        ...
        let remote_detail =
            orbiterx_core_plugins::remote::fetch_remote_plugin_detail_with_download_urls(
                &remote_plugin_service_config,
                auth.as_ref(),
                &remote_marketplace_name,
                &remote_plugin_id,
        ...
        let _remote_plugin_cache_mutation =
            orbiterx_core_plugins::remote::mark_remote_plugin_cache_mutation_in_flight(
                config.orbiterx_home.as_path(),
                &actual_remote_marketplace_name,
                &remote_plugin_name,
            );
        let validated_bundle = orbiterx_core_plugins::remote_bundle::validate_remote_plugin_bundle(
            &remote_plugin_id,
            &actual_remote_marketplace_name,
            &remote_plugin_name,
        ...
        let result =
            orbiterx_core_plugins::remote_bundle::download_and_install_remote_plugin_bundle(
        ...
        let install_result = orbiterx_core_plugins::remote::install_remote_plugin(
            &remote_plugin_service_config,
            auth.as_ref(),
            &actual_remote_marketplace_name,
            &remote_plugin_id,
        ...
        let is_chatgpt_auth = auth.as_ref().is_some_and(OrbiterXAuth::is_chatgpt_auth);
    ...
    async fn plugin_apps_needing_auth_for_install(
        ...
        plugin_id: &str,
        plugin_apps: &[orbiterx_plugin::AppConnectorId],
    ) -> Vec<AppSummary> {
        ...
        let (accessible_connectors, orbiterx_apps_ready) = match accessible_connectors_result {
            Ok(status) => (status.connectors, status.orbiterx_apps_ready),
            Err(err) => {
                warn!(
                    plugin = plugin_id,
        ...
        if !orbiterx_apps_ready {
            warn!(
                plugin = plugin_id,
                "orbiterx_apps MCP not ready after plugin install; skipping appsNeedingAuth check"
            );
        }
    ...
    async fn plugin_uninstall_response(
        ...
        if orbiterx_plugin::PluginId::parse(&plugin_id).is_err()
    ...
    async fn remote_plugin_uninstall_response(
        ...
        let uninstall_target =
            orbiterx_core_plugins::remote::resolve_remote_plugin_uninstall_target(
                &remote_plugin_service_config,
                auth.as_ref(),
                &plugin_id,
            )
        ...
        let uninstall_result = orbiterx_core_plugins::remote::uninstall_remote_plugin(
            &remote_plugin_service_config,
            auth.as_ref(),
            config.orbiterx_home.to_path_buf(),
            uninstall_target,
...
fn plugin_app_category_by_id_from_value(value: &serde_json::Value) -> HashMap<String, String> {
    orbiterx_core_plugins::loader::plugin_app_declarations_from_value(value)
        .into_iter()
...
fn remote_plugin_share_discoverability_to_info(
    discoverability: orbiterx_core_plugins::remote::RemotePluginShareDiscoverability,
...
fn remote_plugin_bundle_install_error_to_jsonrpc(
    err: orbiterx_core_plugins::remote_bundle::RemotePluginBundleInstallError,
) -> JSONRPCErrorError {
