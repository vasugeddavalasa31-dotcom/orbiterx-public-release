    ...
    async fn exec_one_off_command_inner(
        ...
        let (
            ...
            let file_system_sandbox_policy =
                orbiterx_protocol::permissions::FileSystemSandboxPolicy::from_legacy_sandbox_policy_for_cwd(&policy, &sandbox_cwd);
            let network_sandbox_policy =
                orbiterx_protocol::permissions::NetworkSandboxPolicy::from(&policy);
            let permission_profile =
                orbiterx_protocol::models::PermissionProfile::from_runtime_permissions_with_enforcement(
                    orbiterx_protocol::models::SandboxEnforcement::from_legacy_sandbox_policy(&policy),
        ...
        let orbiterx_linux_sandbox_exe = self.arg0_paths.orbiterx_linux_sandbox_exe.clone();
        ...
        let exec_request = orbiterx_core::exec::build_exec_request(
            exec_params,
            &effective_permission_profile,
            &sandbox_cwd,
