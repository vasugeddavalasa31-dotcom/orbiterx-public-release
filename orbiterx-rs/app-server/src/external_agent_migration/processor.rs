...
use orbiterx_analytics::ExternalAgentConfigImportCompletedInput;
use orbiterx_analytics::ExternalAgentConfigImportFailureInput;
...
use orbiterx_app_server_protocol::ExternalAgentConfigImportItemTypeFailure as ProtocolImportFailure;
...
use orbiterx_external_agent_migration::ExternalAgentConfigDetectOptions;
use orbiterx_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use orbiterx_external_agent_migration::ExternalAgentConfigImportOutcome as CoreImportOutcome;
use orbiterx_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use orbiterx_external_agent_migration::ExternalAgentConfigService;
use orbiterx_external_agent_migration::PluginImportOutcome;
use orbiterx_external_agent_migration::record_import_error;
use orbiterx_external_agent_migration::sessions::ExternalAgentSessionMigration as CoreSessionMigration;
use orbiterx_external_agent_migration::sessions::read_imported_connector_candidates;
use orbiterx_features::Feature;
use orbiterx_rollout::StateDbHandle;
use orbiterx_state::ExternalAgentConfigImportFailureRecord;
use orbiterx_state::ExternalAgentConfigImportSuccessRecord;
...
pub(crate) struct ExternalAgentConfigRequestProcessorArgs {
    ...
    pub(crate) orbiterx_home: PathBuf,
}
...
impl ExternalAgentConfigRequestProcessor {
    ...
    pub(crate) async fn read_import_histories(
        ...
        let connectors = read_imported_connector_candidates(self.migration_service.orbiterx_home())
            .map_err(|err| {
