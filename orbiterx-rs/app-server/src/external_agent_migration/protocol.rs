...
use orbiterx_app_server_protocol::CommandMigration;
...
use orbiterx_app_server_protocol::ExternalAgentConfigImportHistory;
use orbiterx_app_server_protocol::ExternalAgentConfigImportItemTypeFailure as ProtocolImportFailure;
use orbiterx_app_server_protocol::ExternalAgentConfigImportItemTypeSuccess as ProtocolImportSuccess;
use orbiterx_app_server_protocol::ExternalAgentConfigImportTypeResult as ProtocolImportTypeResult;
...
use orbiterx_app_server_protocol::HookMigration;
use orbiterx_app_server_protocol::JSONRPCErrorError;
use orbiterx_app_server_protocol::McpServerMigration;
use orbiterx_app_server_protocol::MigrationDetails;
use orbiterx_app_server_protocol::PluginsMigration;
use orbiterx_app_server_protocol::SkillMigration;
use orbiterx_app_server_protocol::SubagentMigration;
use orbiterx_external_agent_migration::ExternalAgentConfigImportItemResult as CoreImportItemResult;
use orbiterx_external_agent_migration::ExternalAgentConfigImportRawError as CoreImportRawError;
use orbiterx_external_agent_migration::ExternalAgentConfigImportSuccess;
use orbiterx_external_agent_migration::ExternalAgentConfigMigrationItem as CoreMigrationItem;
use orbiterx_external_agent_migration::ExternalAgentConfigMigrationItemType as CoreMigrationItemType;
use orbiterx_external_agent_migration::MigrationDetails as CoreMigrationDetails;
use orbiterx_external_agent_migration::NamedMigration;
use orbiterx_external_agent_migration::PluginsMigration as CorePluginsMigration;
use orbiterx_external_agent_migration::sessions::ExternalAgentSessionMigration;
...
fn protocol_migration_details(details: CoreMigrationDetails) -> MigrationDetails {
    MigrationDetails {
        ...
        sessions: details
            .sessions
            .into_iter()
            .map(|session| orbiterx_app_server_protocol::SessionMigration {
                path: session.path,
                cwd: session.cwd,
                title: session.title,
            })
...
pub(super) fn protocol_import_history(
    record: orbiterx_state::ExternalAgentConfigImportHistoryRecord,
