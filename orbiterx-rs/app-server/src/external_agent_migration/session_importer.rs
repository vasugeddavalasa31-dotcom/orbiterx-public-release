...
use orbiterx_external_agent_migration::ExternalAgentConfigImportItemResult;
use orbiterx_external_agent_migration::record_import_error;
use orbiterx_external_agent_migration::sessions::CompletedExternalAgentSessionImport;
use orbiterx_external_agent_migration::sessions::ExternalAgentSessionMigration;
use orbiterx_external_agent_migration::sessions::ImportedExternalAgentSession;
use orbiterx_external_agent_migration::sessions::ImportedSessionConnectorAttribution;
use orbiterx_external_agent_migration::sessions::PendingSessionImport;
use orbiterx_external_agent_migration::sessions::SessionMetadataMode;
use orbiterx_external_agent_migration::sessions::detect_imported_cla_session_connectors;
use orbiterx_external_agent_migration::sessions::prepare_validated_session_import_with_metadata_mode;
use orbiterx_external_agent_migration::sessions::record_completed_session_imports;
...
impl ExternalAgentSessionImporter {
    ...
    pub(super) async fn import_sessions(
        ...
        let completed_imports = completed_imports
            ...
            .collect();
        if let Err(err) = record_completed_session_imports(&self.orbiterx_home, completed_imports) {
            record_import_error(
                &mut item_result,
    ...
    async fn persist_session(
        ...
        let create_params = CreateThreadParams {
            ...
            source: source.clone(),
            thread_source: None,
            originator: orbiterx_login::default_client::originator().value,
