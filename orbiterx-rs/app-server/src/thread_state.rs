...
use orbiterx_file_watcher::WatchRegistration;
...
pub(crate) struct PendingThreadResumeRequest {
    ...
    pub(crate) thread_summary: orbiterx_app_server_protocol::Thread,
    ...
    pub(crate) initial_turns_page:
        Option<orbiterx_app_server_protocol::ThreadResumeInitialTurnsPageParams>,
    pub(crate) resume_cursor_store: Option<Arc<dyn orbiterx_thread_store::ThreadStore>>,
...
pub(crate) struct TurnSummary {
    ...
    pub(crate) item_started: HashSet<String>,
...
pub(crate) struct ThreadState {
    ...
    listener_thread: Option<Weak<OrbiterXThread>>,
    watch_registration: WatchRegistration,
}

impl ThreadState {
    pub(crate) fn listener_matches(&self, conversation: &Arc<OrbiterXThread>) -> bool {
