...
use orbiterx_app_server_protocol::Model;
use orbiterx_app_server_protocol::ModelListParams;
use orbiterx_app_server_protocol::ModelListResponse;
use orbiterx_app_server_protocol::ModelServiceTier;
use orbiterx_app_server_protocol::ModelUpgradeInfo;
use orbiterx_app_server_protocol::ReasoningEffortOption;
...
fn expected_visible_models() -> Vec<Model> {
    ...
    let mut presets = ModelPreset::filter_by_auth(
        orbiterx_core::test_support::all_model_presets().clone(),
        /*chatgpt_mode*/ false,
    );
