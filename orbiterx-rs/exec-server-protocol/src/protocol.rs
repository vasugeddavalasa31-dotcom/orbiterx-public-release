...
pub use orbiterx_file_system::WalkOptions;
pub use orbiterx_file_system::WalkOutcome;
...
use orbiterx_shell_command::shell_detect::DetectedShell;
...
impl EnvironmentInfo {
    ...
    pub fn local() -> Self {
        Self {
            shell: orbiterx_shell_command::shell_detect::default_user_shell().into(),
...
pub struct ExecParams {
    ...
    #[serde(default)]
    pub pipe_stdin: bool,
    /// Optional process-visible argv0 override. Values such as `orbiterx-linux-sandbox` are command
