...
const ENVIRONMENT_CLIENT_NAME: &str = "orbiterx-environment";
...
impl ExecServerClient {
    ...
    #[tracing::instrument(
        name = "orbiterx.exec_server.remote.harness.connect",
        skip_all,
        fields(
            otel.kind = "client",
            otel.name = "orbiterx.exec_server.remote.harness.connect",
        )
    )]
