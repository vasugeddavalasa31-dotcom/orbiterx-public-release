...
impl RpcClient {
    ...
    #[tracing::instrument(
        name = "orbiterx.exec_server.request",
        level = "info",
        skip_all,
        fields(
            otel.kind = "client",
        ...
        T: DeserializeOwned,
    {
        ...
        if self
            ...
            .send(JSONRPCMessage::Request(JSONRPCRequest {
                ...
                method: method.to_string(),
                params: Some(params),
                trace: orbiterx_otel::current_span_w3c_trace_context(),
            }))
            .await
            .is_err()
        {
...
mod tests {
    ...
    async fn rpc_client_propagates_current_trace_context() {
        ...
        let expected_trace = orbiterx_otel::span_w3c_trace_context(&parent_span)
