...
pub(crate) async fn prepare_exec_request(
    ...
    #[cfg(target_os = "linux")]
    let sandbox_helper_paths = std::iter::once(&runtime_paths.orbiterx_self_exe)
        .chain(runtime_paths.orbiterx_linux_sandbox_exe.as_ref())
        .cloned()
        .collect::<Vec<_>>();
    #[cfg(target_os = "linux")]
    ...
    let request = sandbox_manager
        .transform_for_direct_spawn(SandboxDirectSpawnTransformRequest {
            ...
            windows_sandbox_proxy_settings_mode:
                orbiterx_sandboxing::WindowsSandboxProxySettingsMode::Reconcile,
            transform: SandboxTransformRequest {
                ...
                network: None,
                sandbox_policy_cwd,
                orbiterx_linux_sandbox_exe: runtime_paths.orbiterx_linux_sandbox_exe.as_deref(),
