...
use orbiterx_exec_server::FsCloseParams;
use orbiterx_exec_server::FsOpenParams;
use orbiterx_exec_server::FsReadBlockParams;
use orbiterx_exec_server::FsReadBlockResponse;
use orbiterx_exec_server::RemoteExecServerConnectArgs;
...
async fn file_reads_reject_named_pipes() -> Result<()> {
    ...
    let read_path = format!(r"\\.\pipe\orbiterx-fs-read-{}", Uuid::new_v4());
    ...
    let stream_path = format!(r"\\.\pipe\orbiterx-fs-stream-{}", Uuid::new_v4());
