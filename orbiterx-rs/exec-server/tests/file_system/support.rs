...
use orbiterx_exec_server::LocalFileSystem;
...
use crate::common::exec_server::TestOrbiterXHelperPaths;
use crate::common::exec_server::exec_server;
use crate::common::exec_server::test_orbiterx_helper_paths;

pub(crate) struct FileSystemContext {
    pub(crate) file_system: Arc<dyn ExecutorFileSystem>,
    _helper_paths: Option<TestOrbiterXHelperPaths>,
    ...
    match implementation {
        FileSystemImplementation::Local => {
            ...
            let runtime_paths = ExecServerRuntimePaths::new(
                helper_paths.orbiterx_exe.clone(),
                helper_paths.orbiterx_linux_sandbox_exe.clone(),
            )?;
