...
use orbiterx_models_manager::client_version_to_whole;
...
const REMOTE_MODEL: &str = "orbiterx-test-ttl";
const VERSIONED_MODEL: &str = "orbiterx-test-versioned";
const MISSING_VERSION_MODEL: &str = "orbiterx-test-missing-version";
const DIFFERENT_VERSION_MODEL: &str = "orbiterx-test-different-version";
...
async fn renews_cache_ttl_on_matching_models_etag() -> Result<()> {
    ...
    let cache_path = config.orbiterx_home.join(CACHE_FILE);
    ...
    orbiterx
        .submit(Op::UserInput {
            ...
            thread_settings: orbiterx_protocol::protocol::ThreadSettingsOverrides {
                ...
                approval_policy: Some(orbiterx_protocol::protocol::AskForApproval::Never),
    ...
    let _ = wait_for_event(&orbiterx, |event| {
