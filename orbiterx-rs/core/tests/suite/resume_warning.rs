...
async fn emits_warning_when_resumed_model_differs() {
    ...
    let thread_manager = orbiterx_core::test_support::thread_manager_with_models_provider(
        OrbiterXAuth::from_api_key("test"),
        config.model_provider.clone(),
    );
    let auth_manager =
        orbiterx_core::test_support::auth_manager_from_auth(OrbiterXAuth::from_api_key("test"));
