...
use orbiterx_core::context::ApprovalPromptContext;
use orbiterx_core::context::ContextualUserFragment;
use orbiterx_core::context::PermissionsInstructions;
use orbiterx_core::load_exec_policy;
use orbiterx_models_manager::model_info::model_info_from_slug;
use orbiterx_protocol::models::PermissionProfile;
use orbiterx_protocol::openai_models::ApprovalMessages;
use orbiterx_protocol::openai_models::ModelMessages;
use orbiterx_protocol::openai_models::ModelsResponse;
use orbiterx_protocol::openai_models::PermissionMessages;
...
) -> orbiterx_protocol::openai_models::ModelInfo {
...
async fn submit_text_turn(
    test: &core_test_support::test_orbiterx::TestOrbiterX,
    text: &str,
) -> Result<()> {
    test.orbiterx
        .submit(Op::UserInput {
