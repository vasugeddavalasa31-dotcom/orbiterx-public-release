...
impl AgentControl {
    ...
    ) -> OrbiterXResult<V2ResidencySlot> {
        let capacity = config
    ...
    async fn reserve_slot(
        ...
        loop {
            ...
            if !self
                ...
                .await
            {
                return Err(OrbiterXErr::AgentLimitReached {
...
fn is_resident_candidate(thread: &OrbiterXThread) -> bool {
...
async fn is_unloadable(thread: &OrbiterXThread) -> bool {
    matches!(
