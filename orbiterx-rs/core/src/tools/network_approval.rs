...
use orbiterx_network_proxy::BlockedRequest;
...
use orbiterx_network_proxy::NetworkPolicyRequest;
use orbiterx_network_proxy::NetworkProtocol;
...
pub(crate) async fn begin_network_approval(
    ...
    let execution_proxy = network
        ...
        .map_err(|err| {
            ToolError::OrbiterX(orbiterx_protocol::error::OrbiterXErr::Io(io::Error::other(
