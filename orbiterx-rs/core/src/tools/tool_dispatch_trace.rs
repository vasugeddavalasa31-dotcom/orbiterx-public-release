...
//!
//! `orbiterx-rollout-trace` owns the event schema and writer behavior. This module
...
use orbiterx_rollout_trace::ToolDispatchResult;
use orbiterx_rollout_trace::ToolDispatchTraceContext;
...
fn tool_dispatch_invocation(invocation: &ToolInvocation) -> Option<ToolDispatchInvocation> {
    ...
    Some(ToolDispatchInvocation {
        ...
        orbiterx_turn_id: invocation.turn.sub_id.clone(),
