...
use orbiterx_protocol::items::DynamicToolCallStatus;
...
use orbiterx_tools::dynamic_tool_to_responses_api_tool;
    ...
    fn search_info(&self) -> Option<ToolSearchInfo> {
        ToolSearchInfo::from_tool_spec(
            ...
            Some(ToolSearchSourceInfo {
                ...
                description: Some("Tools provided by the current OrbiterX thread.".to_string()),
            }),
        )
    }
