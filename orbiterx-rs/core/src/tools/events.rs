...
use orbiterx_apply_patch::AppliedPatchDelta;
...
use orbiterx_protocol::items::CommandExecutionStatus;
...
impl ToolEmitter {
    ...
    pub async fn finish(
        ...
        let (event, result) = match out {
            ...
            Err(ToolError::OrbiterX(OrbiterXErr::Sandbox(SandboxErr::Timeout { output }))) => {
...
mod tests {
    ...
    async fn assert_failed_apply_patch_tracks_committed_delta(
        ...
        let delta = orbiterx_apply_patch::apply_patch(
    ...
    async fn denied_apply_patch_tracks_committed_delta() {
        ...
        assert_failed_apply_patch_tracks_committed_delta(
            Err(ToolError::OrbiterX(OrbiterXErr::Sandbox(
                SandboxErr::Denied {
