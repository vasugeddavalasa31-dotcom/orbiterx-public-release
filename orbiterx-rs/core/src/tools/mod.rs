...
) -> orbiterx_tools::ToolUserShellType {
    match user_shell.shell_type {
        crate::shell::ShellType::Zsh => orbiterx_tools::ToolUserShellType::Zsh,
        crate::shell::ShellType::Bash => orbiterx_tools::ToolUserShellType::Bash,
        crate::shell::ShellType::PowerShell => orbiterx_tools::ToolUserShellType::PowerShell,
        crate::shell::ShellType::Sh => orbiterx_tools::ToolUserShellType::Sh,
        crate::shell::ShellType::Cmd => orbiterx_tools::ToolUserShellType::Cmd,
    }
}
