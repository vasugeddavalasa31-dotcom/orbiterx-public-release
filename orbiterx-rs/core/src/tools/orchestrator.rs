...
use orbiterx_otel::ToolDecisionSource;
...
impl ToolOrchestrator {
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        let attempt_with_network_approval = SandboxAttempt {
            ...
            orbiterx_linux_sandbox_exe: attempt.orbiterx_linux_sandbox_exe,
        ...
        T: ToolRuntime<Rq, Out>,
    {
        ...
        let initial_attempt = SandboxAttempt {
            ...
            workspace_roots,
            orbiterx_linux_sandbox_exe: turn_ctx.config.orbiterx_linux_sandbox_exe.as_ref(),
            use_legacy_landlock,
        ...
        match first_result {
            ...
            Err(ToolError::OrbiterX(OrbiterXErr::Sandbox(SandboxErr::Denied {
                output,
                ...
                let retry_orbiterx_linux_sandbox_exe = if unsandboxed_allowed {
                    None
                } else {
                    turn_ctx.config.orbiterx_linux_sandbox_exe.as_ref()
                };
                let retry_attempt = SandboxAttempt {
                    ...
                    sandbox_cwd: &sandbox_policy_cwd,
                    workspace_roots,
                    orbiterx_linux_sandbox_exe: retry_orbiterx_linux_sandbox_exe,
                    use_legacy_landlock,
                    windows_sandbox_level: turn_ctx.windows_sandbox_level,
                    windows_sandbox_private_desktop: turn_ctx
                        .config
...
fn sandbox_outcome_from_tool_error(err: &ToolError) -> Option<&'static str> {
    match err {
        ToolError::OrbiterX(OrbiterXErr::Sandbox(SandboxErr::Denied { .. })) => Some("denied"),
        ToolError::OrbiterX(OrbiterXErr::Sandbox(SandboxErr::Timeout { .. })) => Some("timed_out"),
        ToolError::OrbiterX(OrbiterXErr::Sandbox(SandboxErr::Signal(_))) => Some("signal"),
        ToolError::Rejected(_) | ToolError::OrbiterX(_) => None,
    }
}
