//! Root of the `orbiterx-core` library.
...
pub(crate) mod anthropic_translator;
mod apply_patch;
mod apps;
...
pub use responses_metadata::OrbiterXResponsesMetadata;
...
mod config_lock;
mod orbiterx_thread;
pub use orbiterx_thread::BackgroundTerminalInfo;
pub use orbiterx_thread::OrbiterXThread;
pub use orbiterx_thread::OrbiterXThreadSettingsOverrides;
pub use orbiterx_thread::ThreadConfigSnapshot;
pub use orbiterx_thread::TryStartTurnIfIdleError;
pub use orbiterx_thread::TryStartTurnIfIdleRejectionReason;
...
pub use orbiterx_mcp::OrbiterXAppsToolsCache;
pub use orbiterx_mcp::SandboxState;
mod mcp_openai_file;
mod mcp_tool_call;
...
pub use orbiterx_protocol::config_types::ModelProviderAuthInfo;
mod event_mapping;
pub use orbiterx_prompts as review_prompts;
mod thread_manager;
...
#[deprecated(note = "use OrbiterXThread")]
pub type OrbiterXConversation = OrbiterXThread;
...
pub use client::X_ORBITERX_INSTALLATION_ID_HEADER;
pub use client::X_ORBITERX_TURN_METADATA_HEADER;
...
pub use orbiterx_prompts::REVIEW_PROMPT;
pub mod compact;
mod memory_usage;
pub mod otel_init;
