...
use orbiterx_protocol::protocol::GuardianAssessmentAction;
...
use orbiterx_protocol::request_user_input::RequestUserInputEvent;
...
async fn forward_ops_preserves_submission_trace_context() {
    ...
    let submission = Submission {
        ...
        trace: Some(orbiterx_protocol::protocol::W3cTraceContext {
            traceparent: Some(
...
#[tokio::test]
async fn run_orbiterx_thread_interactive_respects_pre_cancelled_spawn() {
    ...
    let result = timeout(
        ...
        run_orbiterx_thread_interactive(
    ...
    assert!(matches!(result, Err(OrbiterXErr::TurnAborted)));
}
