...
use orbiterx_connectors::PluginConnectorSource;
...
impl McpManager {
    pub fn new(plugins_manager: Arc<PluginsManager>) -> Self {
        Self::new_with_extensions(
            plugins_manager,
            orbiterx_extension_api::empty_extension_registry(),
    ...
    pub fn orbiterx_apps_tools_cache(&self) -> ConnectorRuntimeManager<ToolInfo> {
        self.orbiterx_apps_tools_cache.clone()
    }
    ...
    async fn runtime_config_with_context(
        ...
        if mcp_config.apps_enabled {
            catalog.register(McpServerRegistration::from_compatibility(
                ...
                LEGACY_ORBITERX_APPS_REGISTRATION_ID,
