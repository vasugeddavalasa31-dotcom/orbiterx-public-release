...
mod orbiterx_tool_config;
mod orbiterx_tool_runner;
...
pub use crate::orbiterx_tool_config::OrbiterXToolCallParam;
pub use crate::orbiterx_tool_config::OrbiterXToolCallReplyParam;
...
const OTEL_SERVICE_NAME: &str = "orbiterx_mcp_server";
...
mod tests {
    ...
    async fn mcp_server_builds_otel_provider_with_logs_traces_and_metrics() -> anyhow::Result<()> {
        ...
        let provider = orbiterx_core::otel_init::build_provider(
            &config,
            "0.0.0-test",
            Some(OTEL_SERVICE_NAME),
            DEFAULT_ANALYTICS_ENABLED,
