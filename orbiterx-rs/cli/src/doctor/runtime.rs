//! Captures how this OrbiterX process was launched.
//!
...
/// Builds the process provenance row for the current OrbiterX executable.
///
...
pub(super) fn search_check() -> DoctorCheck {
    ...
    if status != CheckStatus::Ok {
        check = check.remediation("Install ripgrep or repair the bundled OrbiterX package.");
    }
    check
}
...
fn build_commit() -> &'static str {
    option_env!("ORBITERX_BUILD_COMMIT")
