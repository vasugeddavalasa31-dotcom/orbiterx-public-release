//! Proxy-aware WebSocket connection setup shared by OrbiterX API clients.
...
use orbiterx_http_client::build_rustls_client_config_with_custom_ca;
...
impl WebSocketConnector {
    /// Creates a connector using native roots and any configured OrbiterX custom CA bundle.
    pub fn new(
        http_client_factory: &HttpClientFactory,
