//! Helpers for truncating tool and exec output using [`TruncationPolicy`](orbiterx_protocol::protocol::TruncationPolicy).

use orbiterx_protocol::models::FunctionCallOutputContentItem;
pub use orbiterx_utils_string::approx_bytes_for_tokens;
pub use orbiterx_utils_string::approx_token_count;
pub use orbiterx_utils_string::approx_tokens_from_byte_count;
use orbiterx_utils_string::truncate_middle_chars;
use orbiterx_utils_string::truncate_middle_with_token_budget;

pub use orbiterx_protocol::protocol::TruncationPolicy;
