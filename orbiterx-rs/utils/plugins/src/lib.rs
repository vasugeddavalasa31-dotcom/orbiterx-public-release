//! Plugin path resolution, plaintext mention sigils, and MCP connector helpers shared across OrbiterX
//! crates.
...
pub use orbiterx_exec_server_protocol::DISCOVERABLE_PLUGIN_MANIFEST_PATHS;
