# orbiterx-utils-stream-parser

Small, dependency-free utilities for parsing streamed text incrementally.

**Disclaimer**: This code is pretty complex and OrbiterX did not manage to write it so before updating the code, make
sure to deeply understand it and don't blindly trust OrbiterX on it. Feel free to update the documentation as you
modify the code
...
```rust
use orbiterx_utils_stream_parser::CitationStreamParser;
use orbiterx_utils_stream_parser::StreamTextParser;
...
```rust
use orbiterx_utils_stream_parser::CitationStreamParser;
use orbiterx_utils_stream_parser::Utf8StreamParser;

# fn demo() -> Result<(), orbiterx_utils_stream_parser::Utf8StreamParserError> {
...
```rust
use orbiterx_utils_stream_parser::InlineHiddenTagParser;
use orbiterx_utils_stream_parser::InlineTagSpec;
use orbiterx_utils_stream_parser::StreamTextParser;
