...
use orbiterx_config::SkillsConfig;
...
impl SkillsService {
    pub fn new(orbiterx_home: AbsolutePathBuf, bundled_skills_enabled: bool) -> Self {
    ...
    pub fn new_with_restriction_product(
        ...
        if !bundled_skills_enabled {
            ...
            uninstall_system_skills(&service.orbiterx_home);
        } else if let Err(err) = install_system_skills(&service.orbiterx_home) {
...
pub fn bundled_skills_enabled_from_stack(
    config_layer_stack: &orbiterx_config::ConfigLayerStack,
) -> bool {
