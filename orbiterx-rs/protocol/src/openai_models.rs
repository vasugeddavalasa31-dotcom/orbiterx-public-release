//! Shared model metadata types exchanged between OrbiterX services and clients.
//!
...
/// Metadata describing a OrbiterX-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the OrbiterX backend `/models` endpoint.
