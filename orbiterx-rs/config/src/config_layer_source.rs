...
/// Provenance for one layer in the effective OrbiterX configuration.
...
pub enum ConfigLayerSource {
    ...
    /// Configuration loaded from a project's `.orbiterx` directory.
    Project {
    ...
    match source {
        ...
        ConfigLayerSource::Project {
            ...
            format!(
                ...
                dot_orbiterx_folder.as_path().display()
            )
        }
