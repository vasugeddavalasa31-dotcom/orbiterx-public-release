use super::*;
use orbiterx_file_system::CopyOptions;
use orbiterx_file_system::CreateDirectoryOptions;
use orbiterx_file_system::ExecutorFileSystemFuture;
use orbiterx_file_system::FileMetadata;
use orbiterx_file_system::FileSystemReadStream;
use orbiterx_file_system::FileSystemSandboxContext;
use orbiterx_file_system::ReadDirectoryEntry;
use orbiterx_file_system::RemoveOptions;
...
"#,
    ...
    assert!(
        message.contains("https://developers.openai.com/orbiterx/config-advanced#profiles"),
        "unexpected error message: {message}"
    );
}
