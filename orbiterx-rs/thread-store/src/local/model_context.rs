...
use orbiterx_rollout::ModelContextScan;
use orbiterx_rollout::ModelContextScanProgress;
use orbiterx_rollout::ReverseJsonlScanner;
use orbiterx_rollout::ScanOutcome;
...
pub(super) async fn load_latest_model_context(
    ...
    let session_meta = orbiterx_rollout::read_session_meta_line(path.as_path())
        .await
