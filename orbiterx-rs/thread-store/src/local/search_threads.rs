...
use orbiterx_rollout::first_rollout_content_match_snippet;
use orbiterx_rollout::parse_cursor;
use orbiterx_rollout::search_rollout_matches;
...
struct ThreadSearchItem {
    item: orbiterx_rollout::ThreadItem,
    snippet: String,
}
...
pub(super) async fn search_threads(
    ...
    loop {
        ...
        for item in page.items {
            let logical_path = orbiterx_rollout::plain_rollout_path(item.path.as_path());
...
) -> Option<orbiterx_rollout::Cursor> {
