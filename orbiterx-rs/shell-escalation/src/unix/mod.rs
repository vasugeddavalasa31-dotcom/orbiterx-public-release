...
//! `EscalateRequest` over the inherited `ORBITERX_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `ORBITERX_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use orbiterx_protocol::approvals::EscalationPermissions;
pub use orbiterx_protocol::approvals::ResolvedPermissionProfile;
