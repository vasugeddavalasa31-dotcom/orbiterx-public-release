...
pub type LoadedPlugin = orbiterx_plugin::LoadedPlugin<orbiterx_config::McpServerConfig>;
pub type PluginLoadOutcome = orbiterx_plugin::PluginLoadOutcome<orbiterx_config::McpServerConfig>;
