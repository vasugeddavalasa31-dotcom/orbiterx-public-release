...
use orbiterx_code_mode_protocol::CodeModeSession;
use orbiterx_code_mode_protocol::CodeModeSessionDelegate;
use orbiterx_code_mode_protocol::CodeModeSessionProvider;
use orbiterx_code_mode_protocol::CodeModeSessionProviderFuture;
use orbiterx_code_mode_protocol::CodeModeSessionResultFuture;
use orbiterx_code_mode_protocol::CodeModeToolKind;
use orbiterx_code_mode_protocol::DEFAULT_EXEC_YIELD_TIME_MS;
use orbiterx_code_mode_protocol::ExecuteRequest;
use orbiterx_code_mode_protocol::ExecuteToPendingOutcome;
use orbiterx_code_mode_protocol::FunctionCallOutputContentItem;
use orbiterx_code_mode_protocol::ImageDetail;
use orbiterx_code_mode_protocol::NotificationFuture;
use orbiterx_code_mode_protocol::RuntimeResponse;
use orbiterx_code_mode_protocol::StartedCell;
use orbiterx_code_mode_protocol::ToolInvocationFuture;
use orbiterx_code_mode_protocol::WaitOutcome;
use orbiterx_code_mode_protocol::WaitRequest;
use orbiterx_code_mode_protocol::WaitToPendingOutcome;
use orbiterx_code_mode_protocol::WaitToPendingRequest;
        ...
        self.delegate
            .invoke_tool(
                CodeModeNestedToolCall {
                    ...
                    tool_name: orbiterx_protocol::ToolName {
