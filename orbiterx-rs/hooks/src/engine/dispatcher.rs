...
pub(crate) fn completed_summary(
    ...
    entries: Vec<orbiterx_protocol::protocol::HookOutputEntry>,
) -> HookRunSummary {
    HookRunSummary {
        id: handler.run_id(),
        event_name: handler.event_name,
...
pub(crate) fn hook_source_label(source: orbiterx_protocol::protocol::HookSource) -> &'static str {
    match source {
        orbiterx_protocol::protocol::HookSource::System => "system",
        orbiterx_protocol::protocol::HookSource::User => "user",
        orbiterx_protocol::protocol::HookSource::Project => "project",
        orbiterx_protocol::protocol::HookSource::Mdm => "mdm",
        orbiterx_protocol::protocol::HookSource::SessionFlags => "session_flags",
        orbiterx_protocol::protocol::HookSource::Plugin => "plugin",
        orbiterx_protocol::protocol::HookSource::CloudRequirements => "cloud_requirements",
        orbiterx_protocol::protocol::HookSource::CloudManagedConfig => "cloud_managed_config",
        orbiterx_protocol::protocol::HookSource::LegacyManagedConfigFile => {
            "legacy_managed_config_file"
        }
        orbiterx_protocol::protocol::HookSource::LegacyManagedConfigMdm => {
            "legacy_managed_config_mdm"
        }
        orbiterx_protocol::protocol::HookSource::Unknown => "unknown",
    }
}
