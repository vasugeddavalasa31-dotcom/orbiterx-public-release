...
use orbiterx_protocol::protocol::HookTrustStatus;
...
pub(crate) struct ConfiguredHandler {
    pub event_name: orbiterx_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            orbiterx_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            orbiterx_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            orbiterx_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            orbiterx_protocol::protocol::HookEventName::PreCompact => "pre-compact",
            orbiterx_protocol::protocol::HookEventName::PostCompact => "post-compact",
            orbiterx_protocol::protocol::HookEventName::SessionStart => "session-start",
            orbiterx_protocol::protocol::HookEventName::SessionEnd => "session-end",
            orbiterx_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
            orbiterx_protocol::protocol::HookEventName::SubagentStart => "subagent-start",
            orbiterx_protocol::protocol::HookEventName::SubagentStop => "subagent-stop",
            orbiterx_protocol::protocol::HookEventName::Stop => "stop",
        }
    }
}
...
impl ClaudeHooksEngine {
    ...
    async fn maybe_spill_prompt_fragments(
        &self,
        session_id: ThreadId,
        fragments: Vec<orbiterx_protocol::items::HookPromptFragment>,
    ) -> Vec<orbiterx_protocol::items::HookPromptFragment> {
        self.output_spiller
