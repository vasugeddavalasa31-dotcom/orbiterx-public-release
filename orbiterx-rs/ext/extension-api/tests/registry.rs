...
use orbiterx_extension_api::ApprovalReviewContributor;
use orbiterx_extension_api::ConfigContributor;
use orbiterx_extension_api::ContextContributor;
use orbiterx_extension_api::ContextualUserFragment;
...
use orbiterx_extension_api::SkillInvocationContributor;
...
use orbiterx_extension_api::TurnInputContributor;
use orbiterx_extension_api::TurnItemContributor;
use orbiterx_extension_api::TurnLifecycleContributor;
use orbiterx_extension_api::empty_extension_registry;
use orbiterx_protocol::items::HookPromptItem;
        ...
        fragments.extend(
            contributor
                .contribute_turn_context(TurnContextContributionInput {
                    thread_id: orbiterx_protocol::ThreadId::default(),
