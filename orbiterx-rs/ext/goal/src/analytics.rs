...
use orbiterx_analytics::GoalEventKind;
use orbiterx_analytics::OrbiterXGoalEvent;
...
impl GoalAnalytics {
    ...
    pub(crate) fn cleared(&self, goal: &orbiterx_state::ThreadGoal) {
    ...
    fn track(
        ...
        self.client.track_goal_event(OrbiterXGoalEvent {
