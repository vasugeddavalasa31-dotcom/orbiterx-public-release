...
use orbiterx_core_plugins::manifest::parse_plugin_manifest_uri;
use orbiterx_exec_server::CapabilityRootDiscovery;
use orbiterx_mcp::parse_executor_plugin_mcp_config;
...
fn parse_mcp_servers(
    selected_root: &SelectedCapabilityRoot,
    plugin_root: &orbiterx_utils_path_uri::PathUri,
    contents: &str,
    environment_id: &str,
) -> Vec<(String, orbiterx_config::McpServerConfig)> {
