use orbiterx_connectors_extension::ExecutorPluginConnectorProvider;
use orbiterx_core::config::Config;
use orbiterx_core_plugins::ExecutorPluginProvider;
...
struct SelectedPluginMetadata {
    ...
    servers: Vec<(String, orbiterx_config::McpServerConfig)>,
