...
use orbiterx_api::AllowedCaller;
use orbiterx_api::ApproximateLocation;
use orbiterx_api::ExternalWebAccess;
use orbiterx_api::ExternalWebAccessMode;
use orbiterx_api::LocationType;
use orbiterx_api::SearchContextSize;
use orbiterx_api::SearchFilters;
...
use orbiterx_extension_api::ThreadOriginator;
...
impl From<&Config> for WebSearchExtensionConfig {
    fn from(config: &Config) -> Self {
        Self {
            ...
            settings: search_settings(config, WebSearchMode::Live),
        }
    }
}
