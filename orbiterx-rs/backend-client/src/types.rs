pub use orbiterx_backend_openapi_models::models::ConfigBundleResponse;
pub use orbiterx_backend_openapi_models::models::CreditStatusDetails;
pub use orbiterx_backend_openapi_models::models::DeliveredConfigToml;
pub use orbiterx_backend_openapi_models::models::DeliveredManagedLayers;
pub use orbiterx_backend_openapi_models::models::DeliveredRequirementsToml;
pub use orbiterx_backend_openapi_models::models::DeliveredTomlFragment;
pub use orbiterx_backend_openapi_models::models::PaginatedListTaskListItem;
pub use orbiterx_backend_openapi_models::models::PlanType;
pub use orbiterx_backend_openapi_models::models::RateLimitReachedKind;
pub use orbiterx_backend_openapi_models::models::RateLimitStatusDetails;
pub use orbiterx_backend_openapi_models::models::RateLimitStatusPayload;
pub use orbiterx_backend_openapi_models::models::RateLimitWindowSnapshot;
pub use orbiterx_backend_openapi_models::models::SpendControlLimitDetails;
pub use orbiterx_backend_openapi_models::models::TaskListItem;
...
#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct OrbiterXWorkspaceMessagesResponse {
    #[serde(default)]
    pub messages: Vec<OrbiterXWorkspaceMessage>,
}

#[derive(Clone, Debug, Deserialize, PartialEq, Eq)]
pub struct OrbiterXWorkspaceMessage {
    pub message_id: String,
    pub message_type: OrbiterXWorkspaceMessageType,
...
#[derive(Clone, Copy, Debug, Deserialize, PartialEq, Eq)]
#[serde(rename_all = "snake_case")]
pub enum OrbiterXWorkspaceMessageType {
    Headline,
    Announcement,
    #[serde(other)]
    Unknown,
...
Second line"
    ...
    fn workspace_messages_response_deserializes_messages() {
        let response: OrbiterXWorkspaceMessagesResponse =
        ...
        assert_eq!(
            response,
            OrbiterXWorkspaceMessagesResponse {
                messages: vec![
                    OrbiterXWorkspaceMessage {
                        message_id: "headline-id".to_string(),
                        message_type: OrbiterXWorkspaceMessageType::Headline,
                    ...
                    OrbiterXWorkspaceMessage {
                        ...
                        message_type: OrbiterXWorkspaceMessageType::Announcement,
                    ...
                    OrbiterXWorkspaceMessage {
                        ...
                        message_type: OrbiterXWorkspaceMessageType::Unknown,
