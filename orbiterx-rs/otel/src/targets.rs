pub(crate) const OTEL_TARGET_PREFIX: &str = "orbiterx_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "orbiterx_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "orbiterx_otel.trace_safe";
