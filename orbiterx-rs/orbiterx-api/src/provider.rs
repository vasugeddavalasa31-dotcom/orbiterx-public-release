...
use orbiterx_client::RequestCompression;
use orbiterx_client::RetryOn;
use orbiterx_client::RetryPolicy;
...
///
/// This is converted into a `RetryPolicy` used by `orbiterx-client` to drive
