...
use orbiterx_client::ReqwestTransport;
...
async fn models_client_hits_models_endpoint() {
    ...
    let base_url = format!("{}/api/orbiterx", server.uri());
    ...
    assert_eq!(received[0].url.path(), "/api/orbiterx/models");
}
