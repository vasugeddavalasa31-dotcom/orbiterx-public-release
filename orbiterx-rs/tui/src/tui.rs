...
/// Restore the terminal after OrbiterX is exiting.
///
...
impl Tui {
    pub(crate) fn new(
        ...
        let is_zellij = orbiterx_terminal_detection::terminal_info().is_zellij();
    ...
    /// terminal modes and stderr (optionally keeping raw mode enabled), then re-applies OrbiterX TUI
