...
mod tests {
    ...
    use orbiterx_app_server_protocol::PluginsMigration;
    use orbiterx_app_server_protocol::SessionMigration;
    use pretty_assertions::assert_eq;
    use ratatui::layout::Rect;
    use std::path::PathBuf;

    fn sample_plugin_details() -> orbiterx_app_server_protocol::MigrationDetails {
        orbiterx_app_server_protocol::MigrationDetails {
            plugins: vec![
                PluginsMigration {
    ...
    fn sample_items() -> Vec<ExternalAgentConfigMigrationItem> {
        ...
        vec![
            ExternalAgentConfigMigrationItem {
                ...
                description:
                    "Migrate /Users/alex/.claude/settings.json into /Users/alex/.orbiterx/config.toml"
                        .to_string(),
                cwd: None,
                details: None,
            },
            ExternalAgentConfigMigrationItem {
                ...
                cwd: None,
                details: Some(orbiterx_app_server_protocol::MigrationDetails {
    ...
    fn sample_items_with_memory() -> Vec<ExternalAgentConfigMigrationItem> {
        ...
        items.insert(
            ...
            ExternalAgentConfigMigrationItem {
                ...
                description: "Migrate memory files from /Users/alex/.claude/projects to /Users/alex/.orbiterx/memories/extensions/external_agent_import/resources".to_string(),
                cwd: None,
                details: Some(orbiterx_app_server_protocol::MigrationDetails {
    ...
    fn secondary_source_customize_snapshot() {
        let items = vec![ExternalAgentConfigMigrationItem {
            item_type: ExternalAgentConfigMigrationItemType::Config,
            description:
                "Migrate /Users/alex/.cursor/cli-config.json into /Users/alex/.orbiterx/config.toml"
                    .to_string(),
            cwd: None,
            details: None,
        }];
