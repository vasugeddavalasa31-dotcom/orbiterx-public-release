//! Built-in pet catalog ported from the OrbiterX App avatar catalog.
...
pub(super) const BUILTIN_PETS: &[BuiltinPet] = &[
    BuiltinPet {
        id: "orbiterx",
        display_name: "OrbiterX",
        description: "The original OrbiterX companion",
        spritesheet_file: "orbiterx-spritesheet-v4.webp",
    },
    BuiltinPet {
        id: "dewey",
        display_name: "Dewey",
