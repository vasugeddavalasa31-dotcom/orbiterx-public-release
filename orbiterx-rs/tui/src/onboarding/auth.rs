...
use orbiterx_app_server_protocol::AuthMode as ApiAuthMode;
...
fn onboarding_request_id() -> orbiterx_app_server_protocol::RequestId {
    orbiterx_app_server_protocol::RequestId::String(Uuid::new_v4().to_string())
}
...
pub(super) async fn cancel_login_attempt(
    ...
    let _ = request_handle
        .request_typed::<orbiterx_app_server_protocol::CancelLoginAccountResponse>(
...
impl AuthModeWidget {
    ...
    fn render_chatgpt_success_message(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            "".into(),
            "  Decide how much autonomy you want to grant OrbiterX".into(),
            Line::from(vec![
                "  For more details see the ".into(),
                crate::terminal_hyperlinks::osc8_hyperlink(
                    "https://developers.openai.com/orbiterx/security",
                    "OrbiterX docs",
                )
                .underlined(),
            ])
            .dim(),
            "".into(),
            "  OrbiterX can make mistakes".into(),
    ...
    fn render_api_key_configured(&self, area: Rect, buf: &mut Buffer) {
        let lines = vec![
            ...
            "".into(),
            "  OrbiterX will use usage-based billing with your API key.".into(),
        ];
...
mod tests {
    ...
    async fn widget_forced_chatgpt() -> (AuthModeWidget, TempDir) {
        ...
        let config = ConfigBuilder::default()
            .orbiterx_home(orbiterx_home_path.clone())
            .build()
            .await
            .unwrap();
        let client = InProcessAppServerClient::start(InProcessClientStartArgs {
            ...
            environment_manager: Arc::new(
                orbiterx_app_server_client::EnvironmentManager::default_for_tests(),
            ),
