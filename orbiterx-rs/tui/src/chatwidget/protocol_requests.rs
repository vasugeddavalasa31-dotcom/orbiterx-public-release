...
impl ChatWidget {
    ...
    pub(super) fn on_guardian_review_notification(
        ...
        turn_id: String,
        started_at_ms: i64,
        review: orbiterx_app_server_protocol::GuardianApprovalReview,
        completion: Option<(i64, orbiterx_app_server_protocol::AutoReviewDecisionSource)>,
        ...
        self.on_guardian_assessment(GuardianAssessmentEvent {
            ...
            status: match review.status {
                orbiterx_app_server_protocol::GuardianApprovalReviewStatus::InProgress => {
                    GuardianAssessmentStatus::InProgress
                }
                orbiterx_app_server_protocol::GuardianApprovalReviewStatus::Approved => {
                    GuardianAssessmentStatus::Approved
                }
                orbiterx_app_server_protocol::GuardianApprovalReviewStatus::Denied => {
                    GuardianAssessmentStatus::Denied
                }
                orbiterx_app_server_protocol::GuardianApprovalReviewStatus::TimedOut => {
                    GuardianAssessmentStatus::TimedOut
                }
                orbiterx_app_server_protocol::GuardianApprovalReviewStatus::Aborted => {
                    GuardianAssessmentStatus::Aborted
                }
            },
            risk_level: review.risk_level.map(|risk_level| match risk_level {
                orbiterx_app_server_protocol::GuardianRiskLevel::Low => {
                    orbiterx_protocol::approvals::GuardianRiskLevel::Low
                }
                orbiterx_app_server_protocol::GuardianRiskLevel::Medium => {
                    orbiterx_protocol::approvals::GuardianRiskLevel::Medium
                }
                orbiterx_app_server_protocol::GuardianRiskLevel::High => {
                    orbiterx_protocol::approvals::GuardianRiskLevel::High
                }
                orbiterx_app_server_protocol::GuardianRiskLevel::Critical => {
                    orbiterx_protocol::approvals::GuardianRiskLevel::Critical
                }
            }),
            user_authorization: review.user_authorization.map(|user_authorization| {
                match user_authorization {
                    orbiterx_app_server_protocol::GuardianUserAuthorization::Unknown => {
                        orbiterx_protocol::approvals::GuardianUserAuthorization::Unknown
                    }
                    orbiterx_app_server_protocol::GuardianUserAuthorization::Low => {
                        orbiterx_protocol::approvals::GuardianUserAuthorization::Low
                    }
                    orbiterx_app_server_protocol::GuardianUserAuthorization::Medium => {
                        orbiterx_protocol::approvals::GuardianUserAuthorization::Medium
                    }
                    orbiterx_app_server_protocol::GuardianUserAuthorization::High => {
                        orbiterx_protocol::approvals::GuardianUserAuthorization::High
                    }
                }
            }),
            rationale: review.rationale,
            decision_source: decision_source.map(|source| match source {
                orbiterx_app_server_protocol::AutoReviewDecisionSource::Agent => {
