//! Shared implementation for `orbiterx archive`, `orbiterx delete`, and `orbiterx unarchive`.
//!
...
async fn start_app_server_for_archive_command(
    ...
    let orbiterx_home = find_orbiterx_home().wrap_err("failed to find OrbiterX home")?;
    ...
    let default_daemon = if explicit_remote_endpoint.is_none() && reuse_implicit_local_daemon {
        super::maybe_probe_default_daemon_socket(orbiterx_home.as_path()).await
    } else {
        None
    };
