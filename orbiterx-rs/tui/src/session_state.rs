...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) approvals_reviewer: orbiterx_protocol::config_types::ApprovalsReviewer,
    ...
    pub(crate) reasoning_effort: Option<orbiterx_protocol::openai_models::ReasoningEffort>,
