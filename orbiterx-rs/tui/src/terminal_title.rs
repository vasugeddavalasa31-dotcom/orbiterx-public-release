...
//! "leave the old title alone" or "clear the title OrbiterX last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title OrbiterX manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before OrbiterX started managing the title.
