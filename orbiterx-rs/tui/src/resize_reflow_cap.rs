...
//! the fallback bucket.
//!
//! These caps are deliberately conservative: OrbiterX is rebuilding normal terminal scrollback, not an
...
use orbiterx_config::types::DEFAULT_TERMINAL_RESIZE_REFLOW_FALLBACK_MAX_ROWS;
