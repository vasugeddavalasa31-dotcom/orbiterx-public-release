...
use orbiterx_app_server_protocol::McpElicitationEnumSchema;
use orbiterx_app_server_protocol::McpElicitationPrimitiveSchema;
use orbiterx_app_server_protocol::McpElicitationSingleSelectEnumSchema;
...
use orbiterx_protocol::mcp_approval_meta::APPROVAL_KIND_KEY as APPROVAL_META_KIND_KEY;
use orbiterx_protocol::mcp_approval_meta::APPROVAL_KIND_MCP_TOOL_CALL as APPROVAL_META_KIND_MCP_TOOL_CALL;
use orbiterx_protocol::mcp_approval_meta::APPROVAL_KIND_TOOL_SUGGESTION as APPROVAL_META_KIND_TOOL_SUGGESTION;
use orbiterx_protocol::mcp_approval_meta::PERSIST_ALWAYS as APPROVAL_PERSIST_ALWAYS_VALUE;
use orbiterx_protocol::mcp_approval_meta::PERSIST_KEY as APPROVAL_PERSIST_KEY;
use orbiterx_protocol::mcp_approval_meta::PERSIST_SESSION as APPROVAL_PERSIST_SESSION_VALUE;
use orbiterx_protocol::mcp_approval_meta::TOOL_NAME_KEY;
use orbiterx_protocol::mcp_approval_meta::TOOL_PARAMS_DISPLAY_KEY as APPROVAL_TOOL_PARAMS_DISPLAY_KEY;
use orbiterx_protocol::mcp_approval_meta::TOOL_PARAMS_KEY as APPROVAL_TOOL_PARAMS_KEY;
    ...
    fn tool_suggestion_meta_is_parsed_into_request_payload() {
        let request = from_form_request(
            ...
            form_request(
                ...
                empty_object_schema(),
                Some(serde_json::json!({
                    "orbiterx_approval_kind": "tool_suggestion",
                    "tool_type": "connector",
