...
//!
//! For the detailed burst state machine, see `orbiterx-rs/tui/src/bottom_pane/paste_burst.rs`.
//!
...
use orbiterx_message_history::HistoryBatchCursor;
...
#[cfg(test)]
use orbiterx_core_skills::model::SkillInterface;
    ...
    fn mention_items(&self) -> Vec<MentionItem> {
            ...
            && let Some(snapshot) = self.connectors_snapshot.as_ref()
        {
            for connector in &snapshot.connectors {
                ...
                let display_name =
                    orbiterx_connectors::metadata::connector_display_label(connector);
...
mod tests {
    ...
    use crate::bottom_pane::textarea::TextArea;
    use orbiterx_protocol::models::local_image_label_text;
    ...
    fn new_test_composer() -> (ChatComposer, UnboundedReceiver<AppEvent>) {
        ...
        (
            ChatComposer::new(
                ...
                "Ask OrbiterX to do anything".to_string(),
        ...
        snapshot_composer_state(
            ...
            |composer| {
                ...
                composer.set_status_line(Some(Line::from(
                    "gpt-5.4 high fast · ~/code/orbiterx-1 · Context 0% used",
                )));
    ...
    fn status_line_hyperlink_marks_pr_number_cells() {
        ...
        let url = "https://github.com/openai/orbiterx/pull/20252";
        composer.set_status_line_enabled(/*enabled*/ true);
    ...
    fn set_skill_mentions_refreshes_open_mention_popup() {
        ...
        composer.set_skill_mentions(Some(vec![SkillMetadata {
            name: "orbiterx".to_string(),
            description: "Primary personal OrbiterX repo skill.".to_string(),
            short_description: None,
            interface: None,
            dependencies: None,
            policy: None,
        ...
        assert_eq!(mention.insert_text, "$orbiterx".to_string());
    ...
    fn default_unified_mention_popup_snapshot() {
        snapshot_composer_state(
            ...
            /*enhanced_keys_supported*/ false,
            |composer| {
                let features = orbiterx_features::Features::with_defaults();
                composer.set_mentions_v2_enabled(
                    features.enabled(orbiterx_features::Feature::MentionsV2),
                );
                composer.set_text_content("@sa".to_string(), Vec::new(), Vec::new());
                composer.set_plugin_mentions(Some(vec![PluginCapabilitySummary {
                    config_name: "sample@test".to_string(),
...
程序员 与 Unicode 同行";
    ...
    fn file_completion_preserves_large_paste_placeholder_elements() {
        ...
        composer.on_file_search_result(
            ...
            vec![FileMatch {
                ...
                match_type: orbiterx_file_search::MatchType::File,
    ...
    fn pasting_filepath_attaches_image() {
        let tmp = tempdir().expect("create TempDir");
        let tmp_path: PathBuf = tmp.path().join("orbiterx_tui_test_paste_image.png");
