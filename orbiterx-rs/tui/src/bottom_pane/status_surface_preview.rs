...
impl StatusSurfacePreviewItem {
    fn placeholder(self) -> &'static str {
        match self {
            StatusSurfacePreviewItem::AppName => "orbiterx",
            ...
            StatusSurfacePreviewItem::OrbiterXVersion => "0.0.0",
            ...
            StatusSurfacePreviewItem::Model => "gpt-5.2-orbiterx",
            StatusSurfacePreviewItem::ModelWithReasoning => "gpt-5.2-orbiterx medium",
