...
use orbiterx_app_server_protocol::FileSystemAccessMode;
use orbiterx_app_server_protocol::FileSystemPath;
use orbiterx_app_server_protocol::FileSystemSandboxEntry;
use orbiterx_app_server_protocol::FileSystemSpecialPath;
use orbiterx_app_server_protocol::McpServerElicitationAction;
use orbiterx_app_server_protocol::NetworkApprovalContext;
use orbiterx_app_server_protocol::NetworkApprovalProtocol;
    ...
    available_decisions
        ...
        .filter_map(|decision| match decision {
            ...
            CommandExecutionApprovalDecision::Cancel => Some(ApprovalOption {
                label: "No, and tell OrbiterX what to do differently".to_string(),
...
mod tests {
    ...
    use orbiterx_app_server_protocol::ExecPolicyAmendment;
    use orbiterx_app_server_protocol::NetworkApprovalProtocol;
    use orbiterx_app_server_protocol::NetworkPolicyAmendment;
    ...
    fn network_exec_options_use_expected_labels_and_hide_execpolicy_amendment() {
        ...
        assert_eq!(
            ...
            vec![
                ...
                "Yes, and allow this host for this conversation".to_string(),
                "Yes, and allow this host in the future".to_string(),
                "No, and tell OrbiterX what to do differently".to_string(),
            ]
        );
    }
    ...
    fn exec_history_cell_wraps_with_two_space_indent() {
        ...
        let rendered: Vec<String> = lines
            ...
            .collect();
        let expected = vec![
            "✔ You approved orbiterx to run".to_string(),
    ...
    fn network_access_command_history_uses_target_without_structured_context() {
        ...
        assert_eq!(
            ...
            vec![
                "✔ You approved orbiterx network access to https://example.com:8443 this time"
                    .to_string(),
            ]
        );
    }
