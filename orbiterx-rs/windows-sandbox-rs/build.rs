...
const SETUP_BIN: &str = "orbiterx-windows-sandbox-setup";
const SETUP_MANIFEST: &str = "orbiterx-windows-sandbox-setup.manifest";
...
fn main() -> Result<(), String> {
    ...
    // Keep this scoped to the setup helper so OrbiterX binaries that link the
