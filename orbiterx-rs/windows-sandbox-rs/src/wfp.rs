...
const SESSION_NAME: &str = "OrbiterX Windows Sandbox WFP";
const PROVIDER_NAME: &str = "OrbiterX Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for OrbiterX Windows sandbox filters";
const SUBLAYER_NAME: &str = "OrbiterX Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for OrbiterX Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are OrbiterX-owned identities; do not regenerate them unless we
...
/// Installs the persistent OrbiterX WFP filters for `account`.
///
...
/// Ensures the persistent OrbiterX WFP provider exists.
...
/// Ensures the persistent OrbiterX sublayer exists under the OrbiterX provider.
