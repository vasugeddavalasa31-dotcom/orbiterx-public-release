...
fn retry_uses_original_unified_exec_request_and_stops_after_second_failure() {
    ...
    let request = RunnerTransportRequest {
        ...
        orbiterx_home: PathBuf::from(r"C:\Users\orbiterx"),
        cwd: PathBuf::from(r"C:\workspace"),
        env_map: env_map.clone(),
        logs_base_dir: Some(PathBuf::from(r"C:\Users\orbiterx\.sandbox")),
        spawn_request: SpawnRequest {
            ...
            orbiterx_home: PathBuf::from(r"C:\Users\orbiterx\.sandbox"),
            real_orbiterx_home: PathBuf::from(r"C:\Users\orbiterx"),
        ...
        deny_write_paths_override: vec![PathBuf::from(r"C:\workspace\.orbiterx")],
        proxy_enforced: true,
    ...
    let expected_refresh = RefreshObservation {
        ...
        env_map,
        orbiterx_home: request.orbiterx_home.clone(),
    ...
    let result = spawn_runner_transport_with_retry(
        ...
        &request,
        |orbiterx_home, cwd, sandbox_creds, logs_base_dir, spawn_request| {
