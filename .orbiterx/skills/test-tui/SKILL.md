---
name: test-tui
description: Guide for testing OrbiterX TUI interactively
---

You can start and use OrbiterX TUI to verify changes. 
...
Use `just orbiterx` target to run - `just orbiterx -c ...`
