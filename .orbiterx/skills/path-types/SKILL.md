---
name: path-types
description: Choose Rust types for operating system paths across the OrbiterX repository. Use when defining new path-bearing types or explicitly migrating existing ones.
---
