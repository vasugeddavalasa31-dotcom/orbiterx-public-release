...
symbols_root="${RUNNER_TEMP:-/tmp}/orbiterx-symbols-${artifact_name}"
symbols_dir="${symbols_root}/orbiterx-symbols-${artifact_name}"
archive_path="${archive_dir%/}/orbiterx-symbols-${artifact_name}.tar.gz"
rm -rf "$symbols_root"
...
rm -f "$archive_path"
tar -C "$symbols_root" -czf "$archive_path" "orbiterx-symbols-${artifact_name}"
